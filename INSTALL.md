...
```bash
composer config repositories.artschekoff/tbankapi vcs https://github.com/artschekoff/tbankapi-php.git
composer require artschekoff/tbankapi:dev-master --prefer-source
```
