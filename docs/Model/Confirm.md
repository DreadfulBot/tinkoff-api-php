...
**receipt** | [**\ArtSchekoff\TBankApi\Models\ConfirmReceipt**](ConfirmReceipt.md) |  | [optional]
**shops** | [**\ArtSchekoff\TBankApi\Models\Shops[]**](Shops.md) | Обязательный для маркетплейсов. JSON-объект с данными маркетплейса. | [optional]
