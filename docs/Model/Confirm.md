...
**receipt** | [**\Roxl\TBankApi\Models\ConfirmReceipt**](ConfirmReceipt.md) |  | [optional]
**shops** | [**\Roxl\TBankApi\Models\Shops[]**](Shops.md) | Обязательный для маркетплейсов. JSON-объект с данными маркетплейса. | [optional]
