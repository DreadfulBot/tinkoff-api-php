...
**receipt** | [**\Roxl\TBankApi\Models\CancelReceipt**](CancelReceipt.md) |  | [optional]
**shops** | [**\Roxl\TBankApi\Models\ShopsCancel[]**](ShopsCancel.md) | Обязательный для маркетплейсов. JSON-объект с данными маркетплейса. | [optional]
