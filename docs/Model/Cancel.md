...
**receipt** | [**\ArtSchekoff\TBankApi\Models\CancelReceipt**](CancelReceipt.md) |  | [optional]
**shops** | [**\ArtSchekoff\TBankApi\Models\ShopsCancel[]**](ShopsCancel.md) | Обязательный для маркетплейсов. JSON-объект с данными маркетплейса. | [optional]
