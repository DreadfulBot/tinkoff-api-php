...
**client_info** | [**\ArtSchekoff\TBankApi\Models\ClientInfo**](.md) |  | [optional]
...
**items** | [**\ArtSchekoff\TBankApi\Models\ItemsFFD105[]**](ItemsFFD105.md) | Массив позиций чека с информацией о товарах (не более 100 позиций). |
**payments** | [**\ArtSchekoff\TBankApi\Models\Payments**](Payments.md) |  | [optional]
