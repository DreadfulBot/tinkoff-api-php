...
**client_info** | [**\Roxl\TBankApi\Models\ClientInfo**](.md) |  | [optional]
...
**items** | [**\Roxl\TBankApi\Models\ItemsFFD105[]**](ItemsFFD105.md) | Массив позиций чека с информацией о товарах (не более 100 позиций). |
**payments** | [**\Roxl\TBankApi\Models\Payments**](Payments.md) |  | [optional]
