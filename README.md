...
```php
<?php
require_once('/path/to/artschekoff/tbankapi/vendor/autoload.php');
```
...
$creq = new \ArtSchekoff\TBankApi\Models\ChallengeRequestCReq(); // \ArtSchekoff\TBankApi\Models\ChallengeRequestCReq
