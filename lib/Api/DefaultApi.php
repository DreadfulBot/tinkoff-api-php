...
/**
    ...
    /**
     * Operation getTerminalPayMethods
     *
     * Проверить доступность методов на SDK
     *
     * @param  \ArtSchekoff\TBankApi\Models\GetTerminalPayMethods $get_terminal_pay_methods get_terminal_pay_methods (required)
     ...
     * @return \ArtSchekoff\TBankApi\Models\GetTerminalPayMethodsResponse
     */
    ...
    {
        list($response) = $this->getTerminalPayMethodsWithHttpInfo($get_terminal_pay_methods, $contentType);
        return $response;
    }

    /**
     * Operation getTerminalPayMethodsWithHttpInfo
     *
     * Проверить доступность методов на SDK
     *
     * @param  \ArtSchekoff\TBankApi\Models\GetTerminalPayMethods $get_terminal_pay_methods (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTerminalPayMethods'] to see the possible values for this operation
     *
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ArtSchekoff\TBankApi\Models\GetTerminalPayMethodsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTerminalPayMethodsWithHttpInfo($get_terminal_pay_methods, string $contentType = self::contentTypes['getTerminalPayMethods'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ArtSchekoff\TBankApi\Models\GetTerminalPayMethodsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ArtSchekoff\TBankApi\Models\GetTerminalPayMethodsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ArtSchekoff\TBankApi\Models\GetTerminalPayMethodsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ArtSchekoff\TBankApi\Models\GetTerminalPayMethodsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ArtSchekoff\TBankApi\Models\GetTerminalPayMethodsResponse',
    ...
    /**
     * Operation getTerminalPayMethodsAsync
     *
     * Проверить доступность методов на SDK
     *
     * @param  \ArtSchekoff\TBankApi\Models\GetTerminalPayMethods $get_terminal_pay_methods (required)
     ...
     */
    public function getTerminalPayMethodsAsync($get_terminal_pay_methods, string $contentType = self::contentTypes['getTerminalPayMethods'][0])
    {
        return $this->getTerminalPayMethodsAsyncWithHttpInfo($get_terminal_pay_methods, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTerminalPayMethodsAsyncWithHttpInfo
     *
     * Проверить доступность методов на SDK
     *
     * @param  \ArtSchekoff\TBankApi\Models\GetTerminalPayMethods $get_terminal_pay_methods (required)
     ...
     */
    public function getTerminalPayMethodsRequest($get_terminal_pay_methods, string $contentType = self::contentTypes['getTerminalPayMethods'][0])
    {

        // verify the required parameter 'get_terminal_pay_methods' is set
        if ($get_terminal_pay_methods === null || (is_array($get_terminal_pay_methods) && count($get_terminal_pay_methods) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $get_terminal_pay_methods when calling getTerminalPayMethods'
            );
        }


        $resourcePath = '/v2/GetTerminalPayMethods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($get_terminal_pay_methods)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($get_terminal_pay_methods));
            } else {
                $httpBody = $get_terminal_pay_methods;
            }
