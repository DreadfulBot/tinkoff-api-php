...
/**
    ...
    /**
     * Operation getDeepLink
     *
     * Получить DeepLink
     *
     * @param  \ArtSchekoff\TBankApi\Models\GetDeepLink $get_deep_link get_deep_link (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDeepLink'] to see the possible values for this operation
     *
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ArtSchekoff\TBankApi\Models\GetDeepLinkResponse
     */
    public function getDeepLink($get_deep_link, string $contentType = self::contentTypes['getDeepLink'][0])
    {
        list($response) = $this->getDeepLinkWithHttpInfo($get_deep_link, $contentType);
        return $response;
    }

    /**
     * Operation getDeepLinkWithHttpInfo
     *
     * Получить DeepLink
     *
     * @param  \ArtSchekoff\TBankApi\Models\GetDeepLink $get_deep_link (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDeepLink'] to see the possible values for this operation
     *
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ArtSchekoff\TBankApi\Models\GetDeepLinkResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDeepLinkWithHttpInfo($get_deep_link, string $contentType = self::contentTypes['getDeepLink'][0])
    {
        $request = $this->getDeepLinkRequest($get_deep_link, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ArtSchekoff\TBankApi\Models\GetDeepLinkResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ArtSchekoff\TBankApi\Models\GetDeepLinkResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ArtSchekoff\TBankApi\Models\GetDeepLinkResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ArtSchekoff\TBankApi\Models\GetDeepLinkResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ArtSchekoff\TBankApi\Models\GetDeepLinkResponse',
     ...
     */
    public function getDeepLinkAsync($get_deep_link, string $contentType = self::contentTypes['getDeepLink'][0])
    {
        return $this->getDeepLinkAsyncWithHttpInfo($get_deep_link, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDeepLinkAsyncWithHttpInfo
     *
     * Получить DeepLink
     *
     * @param  \ArtSchekoff\TBankApi\Models\GetDeepLink $get_deep_link (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDeepLinkAsyncWithHttpInfo($get_deep_link, string $contentType = self::contentTypes['getDeepLink'][0])
    {
        $returnType = '\ArtSchekoff\TBankApi\Models\GetDeepLinkResponse';
        $request = $this->getDeepLinkRequest($get_deep_link, $contentType);
    ...
    /**
     * Create request for operation 'getDeepLink'
     *
     * @param  \ArtSchekoff\TBankApi\Models\GetDeepLink $get_deep_link (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDeepLink'] to see the possible values for this operation
     *
     ...
     */
    public function getDeepLinkRequest($get_deep_link, string $contentType = self::contentTypes['getDeepLink'][0])
    {

        // verify the required parameter 'get_deep_link' is set
        if ($get_deep_link === null || (is_array($get_deep_link) && count($get_deep_link) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $get_deep_link when calling getDeepLink'
            );
        }


        $resourcePath = '/v2/MirPay/GetDeepLink';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($get_deep_link)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($get_deep_link));
            } else {
                $httpBody = $get_deep_link;
            }
