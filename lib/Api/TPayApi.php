...
/**
     ...
     * Получить ссылку
     *
     * @param  float $payment_id Идентификатор платежа в системе Т‑Бизнес (required)
     ...
     * @return \ArtSchekoff\TBankApi\Models\Link200Response
     */
    public function link($payment_id, $version, string $contentType = self::contentTypes['link'][0])
    {
        list($response) = $this->linkWithHttpInfo($payment_id, $version, $contentType);
        return $response;
    }
     ...
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ArtSchekoff\TBankApi\Models\Link200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function linkWithHttpInfo($payment_id, $version, string $contentType = self::contentTypes['link'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ArtSchekoff\TBankApi\Models\Link200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ArtSchekoff\TBankApi\Models\Link200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ArtSchekoff\TBankApi\Models\Link200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ArtSchekoff\TBankApi\Models\Link200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ArtSchekoff\TBankApi\Models\Link200Response',
     ...
     */
    public function linkAsync($payment_id, $version, string $contentType = self::contentTypes['link'][0])
    {
        return $this->linkAsyncWithHttpInfo($payment_id, $version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function linkRequest($payment_id, $version, string $contentType = self::contentTypes['link'][0])
    {

        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling link'
            );
        }
        ...
        if ($version === null || (is_array($version) && count($version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $version when calling link'
            );
        }


        $resourcePath = '/v2/TinkoffPay/transactions/{paymentId}/versions/{version}/link';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function qR($payment_id, string $contentType = self::contentTypes['qR'][0])
    {
        list($response) = $this->qRWithHttpInfo($payment_id, $contentType);
        return $response;
    }

    /**
     * Operation qRWithHttpInfo
     *
     * Получить QR
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. (required)
     ...
     */
    public function qRWithHttpInfo($payment_id, string $contentType = self::contentTypes['qR'][0])
    {
        $request = $this->qRRequest($payment_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function qRAsync($payment_id, string $contentType = self::contentTypes['qR'][0])
    {
        return $this->qRAsyncWithHttpInfo($payment_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function qRAsyncWithHttpInfo($payment_id, string $contentType = self::contentTypes['qR'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->qRRequest($payment_id, $contentType);
    ...
    /**
     * Create request for operation 'qR'
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['qR'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function qRRequest($payment_id, string $contentType = self::contentTypes['qR'][0])
    {

        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling qR'
            );
        }


        $resourcePath = '/v2/TinkoffPay/{paymentId}/QR';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ArtSchekoff\TBankApi\Models\Status200Response
     */
    public function status($terminal_key, string $contentType = self::contentTypes['status'][0])
    {
        list($response) = $this->statusWithHttpInfo($terminal_key, $contentType);
        return $response;
    }
     ...
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ArtSchekoff\TBankApi\Models\Status200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function statusWithHttpInfo($terminal_key, string $contentType = self::contentTypes['status'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ArtSchekoff\TBankApi\Models\Status200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ArtSchekoff\TBankApi\Models\Status200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ArtSchekoff\TBankApi\Models\Status200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ArtSchekoff\TBankApi\Models\Status200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ArtSchekoff\TBankApi\Models\Status200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function statusAsync($terminal_key, string $contentType = self::contentTypes['status'][0])
    {
        return $this->statusAsyncWithHttpInfo($terminal_key, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function statusRequest($terminal_key, string $contentType = self::contentTypes['status'][0])
    {

        // verify the required parameter 'terminal_key' is set
        if ($terminal_key === null || (is_array($terminal_key) && count($terminal_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $terminal_key when calling status'
            );
        }
        if (strlen($terminal_key) > 20) {
            throw new \InvalidArgumentException('invalid length for "$terminal_key" when calling TPayApi.status, must be smaller than or equal to 20.');
        }
        

        $resourcePath = '/v2/TinkoffPay/terminals/{TerminalKey}/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($terminal_key !== null) {
            $resourcePath = str_replace(
                '{' . 'TerminalKey' . '}',
                ObjectSerializer::toPathValue($terminal_key),
                $resourcePath
            );
        }
