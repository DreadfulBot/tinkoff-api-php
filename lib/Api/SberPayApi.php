...
/**
     ...
     */
    public function sberPayQR($payment_id, string $contentType = self::contentTypes['sberPayQR'][0])
    {
        list($response) = $this->sberPayQRWithHttpInfo($payment_id, $contentType);
        return $response;
    }

    /**
     * Operation sberPayQRWithHttpInfo
     *
     * Получить QR
     *
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. (required)
     ...
     */
    public function sberPayQRWithHttpInfo($payment_id, string $contentType = self::contentTypes['sberPayQR'][0])
    {
        $request = $this->sberPayQRRequest($payment_id, $contentType);
     ...
     */
    public function sberPayQRAsync($payment_id, string $contentType = self::contentTypes['sberPayQR'][0])
    {
        return $this->sberPayQRAsyncWithHttpInfo($payment_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sberPayQRAsyncWithHttpInfo
     *
     * Получить QR
     *
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sberPayQRAsyncWithHttpInfo($payment_id, string $contentType = self::contentTypes['sberPayQR'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->sberPayQRRequest($payment_id, $contentType);
    ...
    /**
     * Create request for operation 'sberPayQR'
     *
     * @param  string $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sberPayQR'] to see the possible values for this operation
     *
     ...
     */
    public function sberPayQRRequest($payment_id, string $contentType = self::contentTypes['sberPayQR'][0])
    {

        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling sberPayQR'
            );
        }


        $resourcePath = '/v2/SberPay/{paymentId}/QR';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ArtSchekoff\TBankApi\Models\SberPaylink200Response
     */
    public function sberPaylink($payment_id, string $contentType = self::contentTypes['sberPaylink'][0])
    {
        list($response) = $this->sberPaylinkWithHttpInfo($payment_id, $contentType);
        return $response;
    }

    /**
     * Operation sberPaylinkWithHttpInfo
     *
     * Получить ссылку
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. (required)
     ...
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ArtSchekoff\TBankApi\Models\SberPaylink200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function sberPaylinkWithHttpInfo($payment_id, string $contentType = self::contentTypes['sberPaylink'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ArtSchekoff\TBankApi\Models\SberPaylink200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ArtSchekoff\TBankApi\Models\SberPaylink200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ArtSchekoff\TBankApi\Models\SberPaylink200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ArtSchekoff\TBankApi\Models\SberPaylink200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ArtSchekoff\TBankApi\Models\SberPaylink200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sberPaylinkAsync($payment_id, string $contentType = self::contentTypes['sberPaylink'][0])
    {
        return $this->sberPaylinkAsyncWithHttpInfo($payment_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sberPaylinkAsyncWithHttpInfo
     *
     * Получить ссылку
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. (required)
    ...
    /**
     * Create request for operation 'sberPaylink'
     *
     * @param  float $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sberPaylink'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sberPaylinkRequest($payment_id, string $contentType = self::contentTypes['sberPaylink'][0])
    {

        // verify the required parameter 'payment_id' is set
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling sberPaylink'
            );
        }


        $resourcePath = '/v2/SberPay/transactions/{paymentId}/link';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
