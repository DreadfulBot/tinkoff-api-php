...
/**
     ...
     * @return \ArtSchekoff\TBankApi\Models\Submit3DSAuthorization200Response
     */
     ...
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ArtSchekoff\TBankApi\Models\Submit3DSAuthorization200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function submit3DSAuthorizationWithHttpInfo($md, $pa_res, $payment_id = null, $terminal_key = null, $token = null, string $contentType = self::contentTypes['submit3DSAuthorization'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ArtSchekoff\TBankApi\Models\Submit3DSAuthorization200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ArtSchekoff\TBankApi\Models\Submit3DSAuthorization200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ArtSchekoff\TBankApi\Models\Submit3DSAuthorization200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ArtSchekoff\TBankApi\Models\Submit3DSAuthorization200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ArtSchekoff\TBankApi\Models\Submit3DSAuthorization200Response',
     ...
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ArtSchekoff\TBankApi\Models\Submit3DSAuthorizationV2200Response
     */
     ...
     * @throws \ArtSchekoff\TBankApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ArtSchekoff\TBankApi\Models\Submit3DSAuthorizationV2200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function submit3DSAuthorizationV2WithHttpInfo($payment_id, $terminal_key, $token, string $contentType = self::contentTypes['submit3DSAuthorizationV2'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ArtSchekoff\TBankApi\Models\Submit3DSAuthorizationV2200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ArtSchekoff\TBankApi\Models\Submit3DSAuthorizationV2200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ArtSchekoff\TBankApi\Models\Submit3DSAuthorizationV2200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ArtSchekoff\TBankApi\Models\Submit3DSAuthorizationV2200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ArtSchekoff\TBankApi\Models\Submit3DSAuthorizationV2200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
