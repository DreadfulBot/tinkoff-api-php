 ...
 */
class GetQr implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQr';
    ...
    */
     ...
     * Sets payment_id
     *
     * @param int $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес. Запрос будет работать, даже если указать значение в формате `string`.
     *
     * @return self
     */
     ...
     * Sets data_type
     *
     * @param string|null $data_type Тип возвращаемых данных: * `PAYLOAD` — в ответе возвращается только Payload — по умолчанию; * `IMAGE` — в ответе возвращается SVG изображение QR.
     *
     * @return self
     */
