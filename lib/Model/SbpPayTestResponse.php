...
/**
 * SbpPayTestResponse Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class SbpPayTestResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SbpPayTestResponse';
    ...
    */
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling SbpPayTestResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling SbpPayTestResponse., must be smaller than or equal to 255.');
        }
     ...
     * Sets details
     *
     * @param string $details Подробное описание ошибки
     *
     * @return self
     */
