 ...
 */
class SbpPayTest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SbpPayTest';
    ...
    protected static $setters = [
        ...
        'token' => 'setToken',
        'is_deadline_expired' => 'setIsDeadlineExpired',
        'is_rejected' => 'setIsRejected'
    ];
    ...
    protected static $getters = [
        ...
        'token' => 'getToken',
        'is_deadline_expired' => 'getIsDeadlineExpired',
        'is_rejected' => 'getIsRejected'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_deadline_expired', $data ?? [], null);
        $this->setIfExists('is_rejected', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling SbpPayTest., must be smaller than or equal to 20.');
        }
    ...
    public function setPaymentId($payment_id)
    {
        ...
        if ((mb_strlen($payment_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling SbpPayTest., must be smaller than or equal to 20.');
        }
    ...
    /**
     * Gets is_deadline_expired
     *
     * @return bool|null
     */
    public function getIsDeadlineExpired()
    {
        return $this->container['is_deadline_expired'];
    }

    /**
     * Sets is_deadline_expired
     *
     * @param bool|null $is_deadline_expired Признак эмуляции отказа проведения платежа банком по таймауту. По умолчанию не используется. * `false` — эмуляция не требуется, * `true` — требуется эмуляция. Не может быть использован вместе с `IsRejected` = `true`.
     *
     * @return self
     */
    public function setIsDeadlineExpired($is_deadline_expired)
    {
        if (is_null($is_deadline_expired)) {
            throw new \InvalidArgumentException('non-nullable is_deadline_expired cannot be null');
        }
        $this->container['is_deadline_expired'] = $is_deadline_expired;
    ...
    {
        return $this->container['is_rejected'];
    }

    /**
     * Sets is_rejected
     *
     * @param bool|null $is_rejected Признак эмуляции отказа банка в проведении платежа. По умолчанию не используется. * `false` — эмуляция не требуется, * `true` — требуется эмуляция. Не может быть использован вместе с `IsDeadlineExpired` = `true`.
     *
     * @return self
     */
    public function setIsRejected($is_rejected)
    {
        if (is_null($is_rejected)) {
            throw new \InvalidArgumentException('non-nullable is_rejected cannot be null');
        }
        $this->container['is_rejected'] = $is_rejected;
