 ...
 */
class CheckOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckOrder';
    ...
    */
     ...
     * Sets order_id
     *
     * @param string $order_id Номер заказа в системе мерчанта.   Не является уникальным идентификатором.
     *
     * @return self
     */
