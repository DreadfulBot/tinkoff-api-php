...
/**
 * Link200ResponseParams Class Doc Comment
 *
 * @category Class
 ...
 */
class Link200ResponseParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Link_200_response_Params';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('web_qr', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets redirect_url
     *
     * @param string $redirect_url Link для перехода в приложение MB на мобильных устройствах
     *
     * @return self
     */
    ...
    {
        return $this->container['web_qr'];
    }

    /**
     * Sets web_qr
     *
     * @param string|null $web_qr URL для получения QR
     *
     * @return self
     */
    public function setWebQr($web_qr)
    {
        if (is_null($web_qr)) {
            throw new \InvalidArgumentException('non-nullable web_qr cannot be null');
        }
        $this->container['web_qr'] = $web_qr;
