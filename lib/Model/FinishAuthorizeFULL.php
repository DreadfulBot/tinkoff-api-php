 ...
 */
class FinishAuthorizeFULL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinishAuthorize_FULL';
    ...
    protected static $openAPITypes = [
        ...
        'send_email' => 'bool',
        'source' => 'string',
        'data' => '\RoxlTBankApi\Model\FinishAuthorizeFULLDATA',
        'info_email' => 'string',
    ...
    protected static $setters = [
        ...
        'encrypted_payment_data' => 'setEncryptedPaymentData',
    ...
    protected static $getters = [
        ...
        'encrypted_payment_data' => 'getEncryptedPaymentData',
    ...
    public const SOURCE_CARDS = 'cards';
    public const SOURCE_BEELINE = 'beeline';
    public const SOURCE_MTS = 'mts';
    public const SOURCE_TELE2 = 'tele2';
    public const SOURCE_MEGAFON = 'megafon';
    public const SOURCE_EINVOICING = 'einvoicing';
    public const SOURCE_WEBMONEY = 'webmoney';
    public const ROUTE_ACQ = 'ACQ';
    public const ROUTE_MC = 'MC';
    public const ROUTE_EINV = 'EINV';
    public const ROUTE_WM = 'WM';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('info_email', $data ?? [], null);
        $this->setIfExists('encrypted_payment_data', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['payment_id']) > 20)) {
        ...
        if ($this->container['card_data'] === null) {
            $invalidProperties[] = "'card_data' can't be null";
        }
     ...
     * Sets payment_id
     *
     * @param string $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес.
     *
     * @return self
     */
    public function setPaymentId($payment_id)
    {
        if ((mb_strlen($payment_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling FinishAuthorizeFULL., must be smaller than or equal to 20.');
        }
     ...
     * Sets ip
     *
     * @param string|null $ip IP-адрес клиента. <br> Передача адреса допускается в формате IPv4 и IPv6.  Обязательный параметр для 3DS второй версии. DS платежной системы требует  передавать данный адрес в полном формате,  без каких-либо сокращений — 8 групп по 4 символа.  Этот формат регламентируется на уровне спецификации EMVCo.<br>  Пример правильного адреса — `2011:0db8:85a3:0101:0101:8a2e:0370:7334`.  Пример неправильного адреса — `2a00:1fa1:c7da:9285:0:51:838b:1001`.
     *
     * @return self
     */
     ...
     * Sets send_email
     *
     * @param bool|null $send_email * `true` — отправлять клиенту информацию об оплате на почту; * `false` — не отправлять.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source Источник платежа. Значение параметра зависит от параметра `Route`: - `ACQ` — `cards`. Также поддерживается написание `Cards`. - `MC` — `beeline`, `mts`, `tele2`, `megafon`. - `EINV` — `einvoicing`. - `WM` — `webmoney`.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \RoxlTBankApi\Model\FinishAuthorizeFULLDATA|null
     */
     ...
     * Sets data
     *
     * @param \RoxlTBankApi\Model\FinishAuthorizeFULLDATA|null $data data
     *
     * @return self
     */
     ...
     * Sets info_email
     *
     * @param string|null $info_email Электронная почта для отправки информации об оплате. Обязателен при передаче `SendEmail`.
     *
     * @return self
     */
    public function setInfoEmail($info_email)
    {
        ...
        if (is_null($info_email)) {
            throw new \InvalidArgumentException('non-nullable info_email cannot be null');
        }
    ...
    /**
     * Gets encrypted_payment_data
     *
     * @return string|null
     */
    public function getEncryptedPaymentData()
    {
        return $this->container['encrypted_payment_data'];
    }

    /**
     * Sets encrypted_payment_data
     *
     * @param string|null $encrypted_payment_data Данные карты. Используется и является обязательным только  для ApplePay или GooglePay.
     *
     * @return self
     */
    public function setEncryptedPaymentData($encrypted_payment_data)
    {

        if (is_null($encrypted_payment_data)) {
            throw new \InvalidArgumentException('non-nullable encrypted_payment_data cannot be null');
        }

        $this->container['encrypted_payment_data'] = $encrypted_payment_data;
     ...
     * Sets device_channel
     *
     * @param string|null $device_channel Канал устройства. Поддерживаются следующие каналы: * `01` = Application (APP), * `02` = Browser (BRW) — используется по умолчанию, передавать параметр не требуется.
     *
     * @return self
     */
     ...
     * Sets route
     *
     * @param string|null $route Способ платежа. Обязательный для ApplePay или GooglePay.
     *
     * @return self
     */
