 ...
 */
class ReceiptFFD105 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Receipt_FFD_105';
    ...
    */
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 64)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ReceiptFFD105., must be smaller than or equal to 64.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 64)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ReceiptFFD105., must be smaller than or equal to 64.');
        }
