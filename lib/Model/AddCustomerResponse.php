...
/**
 * AddCustomerResponse Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class AddCustomerResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddCustomerResponse';
    ...
    */
     ...
     * Sets terminal_key
     *
     * @param string $terminal_key Идентификатор терминала, выдается продавцу Т‑Бизнес.
     *
     * @return self
     */
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling AddCustomerResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setCustomerKey($customer_key)
    {
        ...
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling AddCustomerResponse., must be smaller than or equal to 36.');
        }
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling AddCustomerResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling AddCustomerResponse., must be smaller than or equal to 255.');
        }
    ...
    public function setDetails($details)
    {
        ...
        if ((mb_strlen($details) > 255)) {
            throw new \InvalidArgumentException('invalid length for $details when calling AddCustomerResponse., must be smaller than or equal to 255.');
        }
