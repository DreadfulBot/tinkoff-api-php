 ...
 */
class Shops implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Shops';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shop_code'] === null) {
            $invalidProperties[] = "'shop_code' can't be null";
        }
     ...
     * Sets shop_code
     *
     * @param string $shop_code Код магазина
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float $amount Cумма в копейках, которая относится к указанному `ShopCode`.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Shops., must be smaller than or equal to 128.');
        }
     ...
     * Sets fee
     *
     * @param string|null $fee Сумма комиссии в копейках, удерживаемая из возмещения партнера в пользу маркетплейса. Если не передано, используется комиссия, указанная при регистрации.
     *
     * @return self
     */
