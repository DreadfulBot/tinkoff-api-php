...
/**
 * Status200ResponseParams Class Doc Comment
 *
 * @category Class
 ...
 */
class Status200ResponseParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Status_200_response_Params';
    ...
    */
     ...
     * Sets allowed
     *
     * @param bool $allowed Наличие возможности проведения оплаты T‑Pay по API, SDK.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version Версия T‑Pay, доступная на терминале: * `1.0` — e-invoice, * `2.0` — T‑Pay.
     *
     * @return self
     */
