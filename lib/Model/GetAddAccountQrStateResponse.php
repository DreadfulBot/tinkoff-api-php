...
/**
 * GetAddAccountQrStateResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAddAccountQrStateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAddAccountQrStateResponse';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling GetAddAccountQrStateResponse., must be smaller than or equal to 20.');
        }
     ...
     * Sets request_key
     *
     * @param float $request_key Идентификатор запроса на привязку счета.
     *
     * @return self
     */
     ...
     * Sets bank_member_id
     *
     * @param string|null $bank_member_id Идентификатор банка клиента, который будет совершать оплату по привязанному счету — заполнен, если статус `ACTIVE` или `INACTIVE`.
     *
     * @return self
     */
     ...
     * Sets account_token
     *
     * @param string|null $account_token Идентификатор привязки счета, назначаемый банком плательщика.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус привязки карты: * `NEW` — получен запрос на привязку счета; * `PROCESSING` — запрос в обработке, * `ACTIVE` — привязка счета успешна, * `INACTIVE` — привязка счета неуспешна или деактивирована.
     *
     * @return self
     */
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling GetAddAccountQrStateResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling GetAddAccountQrStateResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling GetAddAccountQrStateResponse., must be smaller than or equal to 255.');
        }
