 ...
 */
class GetQrBankListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQrBankListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'error_code' => 'string',
        'message' => 'string',
        'bank_list' => '\RoxlTBankApi\Model\BankList[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bank_list', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bank_list'] === null) {
            $invalidProperties[] = "'bank_list' can't be null";
        }
     ...
     * Gets bank_list
     *
     * @return \RoxlTBankApi\Model\BankList[]
     */
     ...
     * Sets bank_list
     *
     * @param \RoxlTBankApi\Model\BankList[] $bank_list Список банков от НСПК.
     *
     * @return self
     */
    public function setBankList($bank_list)
    {
        ...
        if (is_null($bank_list)) {
            throw new \InvalidArgumentException('non-nullable bank_list cannot be null');
        }
