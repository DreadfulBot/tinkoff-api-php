 ...
 */
class LongPay3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LongPay3';
    ...
    protected static $openAPITypes = [
        'tripleg_date' => 'string',
        'tripleg_time' => 'string',
        'tripleg_carrier' => 'string',
        'tripleg_flight_number' => 'string',
        'tripleg_class' => 'string',
        'tripleg_destination_from' => 'string',
        'tripleg_destination_to' => 'string',
        'tripleg_country_from' => 'string',
        'tripleg_country_to' => 'string',
        'tripleg_stopover' => 'string',
        'tripleg_fare_basis_code' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'tripleg_date' => null,
        'tripleg_time' => null,
        'tripleg_carrier' => null,
        'tripleg_flight_number' => null,
        'tripleg_class' => null,
        'tripleg_destination_from' => null,
        'tripleg_destination_to' => null,
        'tripleg_country_from' => null,
        'tripleg_country_to' => null,
        'tripleg_stopover' => null,
        'tripleg_fare_basis_code' => null
    ];
    ...
    protected static array $openAPINullables = [
        'tripleg_date' => false,
        'tripleg_time' => false,
        'tripleg_carrier' => false,
        'tripleg_flight_number' => false,
        'tripleg_class' => false,
        'tripleg_destination_from' => false,
        'tripleg_destination_to' => false,
        'tripleg_country_from' => false,
        'tripleg_country_to' => false,
        'tripleg_stopover' => false,
        'tripleg_fare_basis_code' => false
    ];
    ...
    protected static $attributeMap = [
        'tripleg_date' => 'triplegDate#',
        'tripleg_time' => 'triplegTime#',
        'tripleg_carrier' => 'triplegCarrier#',
        'tripleg_flight_number' => 'triplegFlightNumber#',
        'tripleg_class' => 'triplegClass#',
        'tripleg_destination_from' => 'triplegDestinationFrom#',
        'tripleg_destination_to' => 'triplegDestinationTo#',
        'tripleg_country_from' => 'triplegCountryFrom#',
        'tripleg_country_to' => 'triplegCountryTo#',
        'tripleg_stopover' => 'triplegStopover#',
        'tripleg_fare_basis_code' => 'triplegFareBasisCode#'
    ];
    ...
    protected static $setters = [
        'tripleg_date' => 'setTriplegDate',
        'tripleg_time' => 'setTriplegTime',
        'tripleg_carrier' => 'setTriplegCarrier',
        'tripleg_flight_number' => 'setTriplegFlightNumber',
        'tripleg_class' => 'setTriplegClass',
        'tripleg_destination_from' => 'setTriplegDestinationFrom',
        'tripleg_destination_to' => 'setTriplegDestinationTo',
        'tripleg_country_from' => 'setTriplegCountryFrom',
        'tripleg_country_to' => 'setTriplegCountryTo',
        'tripleg_stopover' => 'setTriplegStopover',
        'tripleg_fare_basis_code' => 'setTriplegFareBasisCode'
    ];
    ...
    protected static $getters = [
        'tripleg_date' => 'getTriplegDate',
        'tripleg_time' => 'getTriplegTime',
        'tripleg_carrier' => 'getTriplegCarrier',
        'tripleg_flight_number' => 'getTriplegFlightNumber',
        'tripleg_class' => 'getTriplegClass',
        'tripleg_destination_from' => 'getTriplegDestinationFrom',
        'tripleg_destination_to' => 'getTriplegDestinationTo',
        'tripleg_country_from' => 'getTriplegCountryFrom',
        'tripleg_country_to' => 'getTriplegCountryTo',
        'tripleg_stopover' => 'getTriplegStopover',
        'tripleg_fare_basis_code' => 'getTriplegFareBasisCode'
    ];
    ...
    {
        $this->setIfExists('tripleg_date', $data ?? [], null);
        $this->setIfExists('tripleg_time', $data ?? [], null);
        $this->setIfExists('tripleg_carrier', $data ?? [], null);
        $this->setIfExists('tripleg_flight_number', $data ?? [], null);
        $this->setIfExists('tripleg_class', $data ?? [], null);
        $this->setIfExists('tripleg_destination_from', $data ?? [], null);
        $this->setIfExists('tripleg_destination_to', $data ?? [], null);
        $this->setIfExists('tripleg_country_from', $data ?? [], null);
        $this->setIfExists('tripleg_country_to', $data ?? [], null);
        $this->setIfExists('tripleg_stopover', $data ?? [], null);
        $this->setIfExists('tripleg_fare_basis_code', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tripleg_date'] === null) {
            $invalidProperties[] = "'tripleg_date' can't be null";
        }
        if ($this->container['tripleg_carrier'] === null) {
            $invalidProperties[] = "'tripleg_carrier' can't be null";
        }
        if ($this->container['tripleg_destination_from'] === null) {
            $invalidProperties[] = "'tripleg_destination_from' can't be null";
        }
        if ($this->container['tripleg_destination_to'] === null) {
            $invalidProperties[] = "'tripleg_destination_to' can't be null";
        }
     ...
     * @return string
     */
    public function getTriplegDate()
    {
        return $this->container['tripleg_date'];
    }

    /**
     * Sets tripleg_date
     *
     * @param string $tripleg_date Дата вылета в формате` YYYY-DD-MM`.
     *
     * @return self
     */
    public function setTriplegDate($tripleg_date)
    {
        if (is_null($tripleg_date)) {
            throw new \InvalidArgumentException('non-nullable tripleg_date cannot be null');
        }
        $this->container['tripleg_date'] = $tripleg_date;
     ...
     * @return string|null
     */
    public function getTriplegTime()
    {
        return $this->container['tripleg_time'];
    }

    /**
     * Sets tripleg_time
     *
     * @param string|null $tripleg_time Время вылета в формате `hh24:mm:ss`.
     *
     * @return self
     */
    public function setTriplegTime($tripleg_time)
    {
        if (is_null($tripleg_time)) {
            throw new \InvalidArgumentException('non-nullable tripleg_time cannot be null');
        }
        $this->container['tripleg_time'] = $tripleg_time;

        return $this;
    }

    /**
     * Gets tripleg_carrier
     *
     * @return string
     */
    public function getTriplegCarrier()
    {
        return $this->container['tripleg_carrier'];
    }

    /**
     * Sets tripleg_carrier
     *
     * @param string $tripleg_carrier Код перевозчика `ИАТА`.
     *
     * @return self
     */
    public function setTriplegCarrier($tripleg_carrier)
    {
        if (is_null($tripleg_carrier)) {
            throw new \InvalidArgumentException('non-nullable tripleg_carrier cannot be null');
        }
        $this->container['tripleg_carrier'] = $tripleg_carrier;

        return $this;
    }

    /**
     * Gets tripleg_flight_number
     *
     * @return string|null
     */
    public function getTriplegFlightNumber()
    {
        return $this->container['tripleg_flight_number'];
    }

    /**
     * Sets tripleg_flight_number
     *
     * @param string|null $tripleg_flight_number Номер рейса.
     *
     * @return self
     */
    public function setTriplegFlightNumber($tripleg_flight_number)
    {
        if (is_null($tripleg_flight_number)) {
            throw new \InvalidArgumentException('non-nullable tripleg_flight_number cannot be null');
        }
        $this->container['tripleg_flight_number'] = $tripleg_flight_number;
     ...
     * @return string|null
     */
    public function getTriplegClass()
    {
        return $this->container['tripleg_class'];
    }

    /**
     * Sets tripleg_class
     *
     * @param string|null $tripleg_class Класс перелета.
     *
     * @return self
     */
    public function setTriplegClass($tripleg_class)
    {
        if (is_null($tripleg_class)) {
            throw new \InvalidArgumentException('non-nullable tripleg_class cannot be null');
        }
        $this->container['tripleg_class'] = $tripleg_class;

        return $this;
    }

    /**
     * Gets tripleg_destination_from
     *
     * @return string
     */
    public function getTriplegDestinationFrom()
    {
        return $this->container['tripleg_destination_from'];
    }

    /**
     * Sets tripleg_destination_from
     *
     * @param string $tripleg_destination_from Код аэропорта вылета ИАТА.
     *
     * @return self
     */
    public function setTriplegDestinationFrom($tripleg_destination_from)
    {
        if (is_null($tripleg_destination_from)) {
            throw new \InvalidArgumentException('non-nullable tripleg_destination_from cannot be null');
        }
        $this->container['tripleg_destination_from'] = $tripleg_destination_from;

        return $this;
    }

    /**
     * Gets tripleg_destination_to
     *
     * @return string
     */
    public function getTriplegDestinationTo()
    {
        return $this->container['tripleg_destination_to'];
    }

    /**
     * Sets tripleg_destination_to
     *
     * @param string $tripleg_destination_to Код аэропорта прилета ИАТА.
     *
     * @return self
     */
    public function setTriplegDestinationTo($tripleg_destination_to)
    {
        if (is_null($tripleg_destination_to)) {
            throw new \InvalidArgumentException('non-nullable tripleg_destination_to cannot be null');
        }
        $this->container['tripleg_destination_to'] = $tripleg_destination_to;

        return $this;
    }

    /**
     * Gets tripleg_country_from
     *
     * @return string|null
     */
    public function getTriplegCountryFrom()
    {
        return $this->container['tripleg_country_from'];
    }

    /**
     * Sets tripleg_country_from
     *
     * @param string|null $tripleg_country_from Код страны вылета по стандарту `ISO 3166-1 numeric`.
     *
     * @return self
     */
    public function setTriplegCountryFrom($tripleg_country_from)
    {
        if (is_null($tripleg_country_from)) {
            throw new \InvalidArgumentException('non-nullable tripleg_country_from cannot be null');
        }
        $this->container['tripleg_country_from'] = $tripleg_country_from;

        return $this;
    }

    /**
     * Gets tripleg_country_to
     *
     * @return string|null
     */
    public function getTriplegCountryTo()
    {
        return $this->container['tripleg_country_to'];
    }

    /**
     * Sets tripleg_country_to
     *
     * @param string|null $tripleg_country_to Код страны прилета по стандарту `ISO 3166-1 numeric`.
     *
     * @return self
     */
    public function setTriplegCountryTo($tripleg_country_to)
    {
        if (is_null($tripleg_country_to)) {
            throw new \InvalidArgumentException('non-nullable tripleg_country_to cannot be null');
        }
        $this->container['tripleg_country_to'] = $tripleg_country_to;

        return $this;
    }

    /**
     * Gets tripleg_stopover
     *
     * @return string|null
     */
    public function getTriplegStopover()
    {
        return $this->container['tripleg_stopover'];
    }

    /**
     * Sets tripleg_stopover
     *
     * @param string|null $tripleg_stopover Остановка при пересадке: * `0` — разрешена, * `X` — запрещена.
     *
     * @return self
     */
    public function setTriplegStopover($tripleg_stopover)
    {
        if (is_null($tripleg_stopover)) {
            throw new \InvalidArgumentException('non-nullable tripleg_stopover cannot be null');
        }
        $this->container['tripleg_stopover'] = $tripleg_stopover;

        return $this;
    }

    /**
     * Gets tripleg_fare_basis_code
     *
     * @return string|null
     */
    public function getTriplegFareBasisCode()
    {
        return $this->container['tripleg_fare_basis_code'];
    }

    /**
     * Sets tripleg_fare_basis_code
     *
     * @param string|null $tripleg_fare_basis_code Код тарифа.
     *
     * @return self
     */
    public function setTriplegFareBasisCode($tripleg_fare_basis_code)
    {
        if (is_null($tripleg_fare_basis_code)) {
            throw new \InvalidArgumentException('non-nullable tripleg_fare_basis_code cannot be null');
        }
        $this->container['tripleg_fare_basis_code'] = $tripleg_fare_basis_code;
