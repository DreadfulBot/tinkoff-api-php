 ...
 */
class LongPay2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LongPay2';
    ...
    protected static $openAPITypes = [
        'ticket_passenger_surname' => 'string',
        'ticket_passenger_firstname' => 'string',
        'passenger_passport' => 'string',
        'passenger_country' => 'string',
        'ticket_passenger_birth_date' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'ticket_passenger_surname' => null,
        'ticket_passenger_firstname' => null,
        'passenger_passport' => null,
        'passenger_country' => null,
        'ticket_passenger_birth_date' => null
    ];
    ...
    protected static array $openAPINullables = [
        'ticket_passenger_surname' => false,
        'ticket_passenger_firstname' => false,
        'passenger_passport' => false,
        'passenger_country' => false,
        'ticket_passenger_birth_date' => false
    ];
    ...
    protected static $attributeMap = [
        'ticket_passenger_surname' => 'ticketPassengerSurname%',
        'ticket_passenger_firstname' => 'ticketPassengerFirstname%',
        'passenger_passport' => 'passengerPassport%',
        'passenger_country' => 'passengerCountry%',
        'ticket_passenger_birth_date' => 'ticketPassengerBirthDate%'
    ];
    ...
    protected static $setters = [
        'ticket_passenger_surname' => 'setTicketPassengerSurname',
        'ticket_passenger_firstname' => 'setTicketPassengerFirstname',
        'passenger_passport' => 'setPassengerPassport',
        'passenger_country' => 'setPassengerCountry',
        'ticket_passenger_birth_date' => 'setTicketPassengerBirthDate'
    ];
    ...
    protected static $getters = [
        'ticket_passenger_surname' => 'getTicketPassengerSurname',
        'ticket_passenger_firstname' => 'getTicketPassengerFirstname',
        'passenger_passport' => 'getPassengerPassport',
        'passenger_country' => 'getPassengerCountry',
        'ticket_passenger_birth_date' => 'getTicketPassengerBirthDate'
    ];
    ...
    {
        $this->setIfExists('ticket_passenger_surname', $data ?? [], null);
        $this->setIfExists('ticket_passenger_firstname', $data ?? [], null);
        $this->setIfExists('passenger_passport', $data ?? [], null);
        $this->setIfExists('passenger_country', $data ?? [], null);
        $this->setIfExists('ticket_passenger_birth_date', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ticket_passenger_surname'] === null) {
            $invalidProperties[] = "'ticket_passenger_surname' can't be null";
        }
        if ($this->container['ticket_passenger_firstname'] === null) {
            $invalidProperties[] = "'ticket_passenger_firstname' can't be null";
        }
    ...
    /**
     * Gets ticket_passenger_surname
     *
     * @return string
     */
    public function getTicketPassengerSurname()
    {
        return $this->container['ticket_passenger_surname'];
    }

    /**
     * Sets ticket_passenger_surname
     *
     * @param string $ticket_passenger_surname Фамилия латиницей.
     *
     * @return self
     */
    public function setTicketPassengerSurname($ticket_passenger_surname)
    {
        if (is_null($ticket_passenger_surname)) {
            throw new \InvalidArgumentException('non-nullable ticket_passenger_surname cannot be null');
        }
        $this->container['ticket_passenger_surname'] = $ticket_passenger_surname;

        return $this;
    }

    /**
     * Gets ticket_passenger_firstname
     *
     * @return string
     */
    public function getTicketPassengerFirstname()
    {
        return $this->container['ticket_passenger_firstname'];
    }

    /**
     * Sets ticket_passenger_firstname
     *
     * @param string $ticket_passenger_firstname Имя латиницей.
     *
     * @return self
     */
    public function setTicketPassengerFirstname($ticket_passenger_firstname)
    {
        if (is_null($ticket_passenger_firstname)) {
            throw new \InvalidArgumentException('non-nullable ticket_passenger_firstname cannot be null');
        }
        $this->container['ticket_passenger_firstname'] = $ticket_passenger_firstname;

        return $this;
    }

    /**
     * Gets passenger_passport
     *
     * @return string|null
     */
    public function getPassengerPassport()
    {
        return $this->container['passenger_passport'];
    }

    /**
     * Sets passenger_passport
     *
     * @param string|null $passenger_passport Серия и номер паспорта.
     *
     * @return self
     */
    public function setPassengerPassport($passenger_passport)
    {
        if (is_null($passenger_passport)) {
            throw new \InvalidArgumentException('non-nullable passenger_passport cannot be null');
        }
        $this->container['passenger_passport'] = $passenger_passport;
     ...
     *
     * @param string|null $passenger_country Гражданство по стандарту `ISO 3166-1 alpha-3`.
     *
     * @return self
     */
    public function setPassengerCountry($passenger_country)
    {
        if (is_null($passenger_country)) {
            throw new \InvalidArgumentException('non-nullable passenger_country cannot be null');
        }
    ...
    /**
     * Gets ticket_passenger_birth_date
     *
     * @return string|null
     */
    public function getTicketPassengerBirthDate()
    {
        return $this->container['ticket_passenger_birth_date'];
    }

    /**
     * Sets ticket_passenger_birth_date
     *
     * @param string|null $ticket_passenger_birth_date Дата рождения в формате `YYYY-DD-MM`.
     *
     * @return self
     */
    public function setTicketPassengerBirthDate($ticket_passenger_birth_date)
    {
        if (is_null($ticket_passenger_birth_date)) {
            throw new \InvalidArgumentException('non-nullable ticket_passenger_birth_date cannot be null');
        }
        $this->container['ticket_passenger_birth_date'] = $ticket_passenger_birth_date;
