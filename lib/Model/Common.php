 ...
 */
class Common implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        $allowedValues = $this->getOperationInitiatorTypeAllowableValues();
        if (!is_null($operation_initiator_type) && !in_array($operation_initiator_type, $allowedValues, true)) {
