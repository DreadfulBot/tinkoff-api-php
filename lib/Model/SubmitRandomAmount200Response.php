...
/**
 * SubmitRandomAmount200Response Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class SubmitRandomAmount200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitRandomAmount_200_response';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling SubmitRandomAmount200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setCustomerKey($customer_key)
    {
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling SubmitRandomAmount200Response., must be smaller than or equal to 36.');
        }
    ...
    public function setCardId($card_id)
    {
        if ((mb_strlen($card_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $card_id when calling SubmitRandomAmount200Response., must be smaller than or equal to 40.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling SubmitRandomAmount200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setStatus($status)
    {
        if (!is_null($status) && (mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling SubmitRandomAmount200Response., must be smaller than or equal to 20.');
        }
