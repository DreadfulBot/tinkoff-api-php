...
/**
 * QrResponseFULL Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class QrResponseFULL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QrResponse_FULL';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling QrResponseFULL., must be smaller than or equal to 20.');
        }
     ...
     * Sets order_id
     *
     * @param string $order_id Номер заказа в системе мерчанта.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param string $data В зависимости от параметра `DataType` в запросе:   * `Payload` — информация, которая должна быть закодирована в QR;   * `SVG` — изображение QR, в котором уже закодирован Payload.
     *
     * @return self
     */
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling QrResponseFULL., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling QrResponseFULL., must be smaller than or equal to 255.');
        }
     ...
     * Sets request_key
     *
     * @param float $request_key Идентификатор запроса на привязку счета. Передается в случае привязки и одновременной оплаты по CБП.
     *
     * @return self
     */
