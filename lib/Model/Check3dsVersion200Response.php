...
/**
 * Check3dsVersion200Response Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class Check3dsVersion200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Check3dsVersion_200_response';
    ...
    */
     ...
     * Sets version
     *
     * @param string $version Версия протокола 3DS.  Примеры: * `1.0.0` — первая версия, * `2.1.0` — вторая версия.
     *
     * @return self
     */
     ...
     *
     * @param string|null $tds_server_trans_id Уникальный идентификатор транзакции, который генерируется 3DS-Server. Обязательный параметр для 3DS второй версии.
     *
     * @return self
     */
     ...
     *
     * @param string|null $three_ds_method_url Дополнительный параметр для 3DS второй версии, который позволяет пройти этап по сбору данных браузера ACS-ом.
     *
     * @return self
     */
     ...
     * Sets payment_system
     *
     * @param string $payment_system Платежная система карты.
     *
     * @return self
     */
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling Check3dsVersion200Response., must be smaller than or equal to 20.');
        }
