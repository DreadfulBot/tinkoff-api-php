...
/**
 * GetAccountQrList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAccountQrList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAccountQrList';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling GetAccountQrList., must be smaller than or equal to 20.');
        }
