 ...
 */
class ChargeQr implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChargeQr';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling ChargeQr., must be smaller than or equal to 20.');
        }
     ...
     * Sets account_token
     *
     * @param string $account_token Идентификатор привязки счета, назначаемый банком-эмитентом.
     *
     * @return self
     */
     ...
     * Sets info_email
     *
     * @param string|null $info_email Адрес почты клиента. Обязательно, если передан параметр `SendEmail` = `true`.
     *
     * @return self
     */
