...
/**
 * GetAccountQrListResponseAccountTokensInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAccountQrListResponseAccountTokensInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAccountQrListResponse_AccountTokens_inner';
    ...
    */
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling GetAccountQrListResponseAccountTokensInner., must be smaller than or equal to 20.');
        }
     ...
     * Sets account_token
     *
     * @param object|null $account_token Идентификатор привязки счета, назначаемый банком плательщика.
     *
     * @return self
     */
     ...
     * Sets bank_member_id
     *
     * @param string|null $bank_member_id Идентификатор банка клиента (эмитент), который будет совершать оплату по привязанному счету — заполнен, если статус `ACTIVE` или `INACTIVE`.
     *
     * @return self
     */
