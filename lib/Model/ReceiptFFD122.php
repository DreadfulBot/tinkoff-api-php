 ...
 */
class ReceiptFFD122 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Receipt_FFD_12-2';
    ...
    */
     ...
     * Sets ffd_version
     *
     * @param string|null $ffd_version Версия ФФД. Возможные значения: * FfdVersion: `1.2`, * FfdVersion: `1.05`.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email Электронная почта клиента.
     *
     * @return self
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 64)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ReceiptFFD122., must be smaller than or equal to 64.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 64)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ReceiptFFD122., must be smaller than or equal to 64.');
        }
     ...
     * Gets items
     *
     * @return \RoxlTBankApi\Model\ItemsFFD12[]|null
     */
     ...
     * Sets items
     *
     * @param \RoxlTBankApi\Model\ItemsFFD12[]|null $items Массив, содержащий в себе информацию о товарах.
     *
     * @return self
     */
