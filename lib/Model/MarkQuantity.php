...
class MarkQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets numerator
     *
     * @param float|null $numerator `Тег ФФД: 1293`   Числитель дробной части предмета расчета.  Значение должно быть строго меньше значения реквизита «знаменатель».
     *
     * @return self
     */
     ...
     * Sets denominator
     *
     * @param float|null $denominator `Тег ФФД: 1294`   Знаменатель дробной части предмета расчета.  Значение равно количеству товара в партии (упаковке),  имеющей общий код маркировки товара.
     *
     * @return self
     */
