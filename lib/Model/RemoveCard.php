 ...
 */
class RemoveCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoveCard';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling RemoveCard., must be smaller than or equal to 20.');
        }
    ...
    public function setCustomerKey($customer_key)
    {
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling RemoveCard., must be smaller than or equal to 36.');
        }
    ...
    public function setCardId($card_id)
    {
        if ((mb_strlen($card_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $card_id when calling RemoveCard., must be smaller than or equal to 40.');
        }
    ...
    public function setIp($ip)
    {
        if (!is_null($ip) && (mb_strlen($ip) > 40)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling RemoveCard., must be smaller than or equal to 40.');
        }
