...
/**
 * GetDeepLinkResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetDeepLinkResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetDeepLinkResponse';
    ...
    */
     ...
     * Sets deeplink
     *
     * @param string|null $deeplink Сформированный и подписанный JWT-токеном deeplink.
     *
     * @return self
     */
