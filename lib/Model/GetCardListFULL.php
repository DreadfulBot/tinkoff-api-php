...
/**
 * GetCardListFULL Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class GetCardListFULL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCardList_FULL';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('saved_card', $data ?? [], null);
    ...
    */
     ...
     * Sets saved_card
     *
     * @param bool|null $saved_card Признак сохранения карты для оплаты в 1 клик.
     *
     * @return self
     */
    public function setSavedCard($saved_card)
    {
        if (is_null($saved_card)) {
            throw new \InvalidArgumentException('non-nullable saved_card cannot be null');
        }
