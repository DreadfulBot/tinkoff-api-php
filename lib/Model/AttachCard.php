 ...
 */
class AttachCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttachCard';
    ...
    protected static $openAPITypes = [
        ...
        'request_key' => 'string',
        'card_data' => 'string',
        'data' => '\RoxlTBankApi\Model\AttachCardDATA',
        'token' => 'string'
    ];
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling AttachCard., must be smaller than or equal to 20.');
        }
     ...
     * Gets data
     *
     * @return \RoxlTBankApi\Model\AttachCardDATA|null
     */
     ...
     * Sets data
     *
     * @param \RoxlTBankApi\Model\AttachCardDATA|null $data data
     *
     * @return self
     */
