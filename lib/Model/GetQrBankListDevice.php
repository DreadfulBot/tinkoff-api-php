...
/**
 * GetQrBankListDevice Class Doc Comment
 *
 * @category Class
 ...
 */
class GetQrBankListDevice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQrBankList_Device';
    ...
    */
     ...
     * Sets os
     *
     * @param string|null $os ОС устройства.
     *
     * @return self
     */
    public function setOs($os)
    {
        if (!is_null($os) && (mb_strlen($os) > 255)) {
            throw new \InvalidArgumentException('invalid length for $os when calling GetQrBankListDevice., must be smaller than or equal to 255.');
        }
