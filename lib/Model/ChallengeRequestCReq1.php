 ...
 */
class ChallengeRequestCReq1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Challenge_Request__CReq__1';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trans_status'] === null) {
            $invalidProperties[] = "'trans_status' can't be null";
        }
        if ($this->container['message_type'] === null) {
            $invalidProperties[] = "'message_type' can't be null";
        }
        if ($this->container['message_version'] === null) {
            $invalidProperties[] = "'message_version' can't be null";
        }
     ...
     *
     * @param string $three_ds_server_trans_id Идентификатор транзакции из ответа метода Check3DSVersion
     *
     * @return self
     */
     ...
     * Sets acs_trans_id
     *
     * @param string $acs_trans_id Идентификатор транзакции, присвоенный ACS, полученный в ответе на FinishAuthorize
     *
     * @return self
     */
     ...
     * Sets trans_status
     *
     * @param string $trans_status Результат выполнения Challenge flow, возможны 2 значения — Y/N. <br> Y — аутентификация выполнена успешна,  <br> N — аутентификация не пройдена, клиент отказался или ввел неверные данные.  <br>
     *
     * @return self
     */
     ...
     * Sets message_type
     *
     * @param string $message_type Передается фиксированное значение «CRes»
     *
     * @return self
     */
     ...
     *
     * @param string $message_version Версия 3DS
     *
     * @return self
     */
