 ...
 */
class GetState200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetState_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'details' => 'string',
        'params' => '\RoxlTBankApi\Model\ItemsParams[]'
    ];
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling GetState200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setOrderId($order_id)
    {
        if ((mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling GetState200Response., must be smaller than or equal to 36.');
        }
     ...
     * Sets status
     *
     * @param string $status Статус платежа. Подробнее — в разделе [Статусная модель платежа](#tag/Scenarii-oplaty-po-karte/Statusnaya-model-platezha).
     *
     * @return self
     */
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling GetState200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setPaymentId($payment_id)
    {
        if ((mb_strlen($payment_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling GetState200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling GetState200Response., must be smaller than or equal to 20.');
        }
     ...
     * Gets params
     *
     * @return \RoxlTBankApi\Model\ItemsParams[]|null
     */
     ...
     * Sets params
     *
     * @param \RoxlTBankApi\Model\ItemsParams[]|null $params Информация по способу оплаты или деталям для платежей в рассрочку.
     *
     * @return self
     */
