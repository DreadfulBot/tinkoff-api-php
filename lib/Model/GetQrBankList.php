 ...
 */
class GetQrBankList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQrBankList';
    ...
    protected static $openAPITypes = [
        ...
        'device' => '\RoxlTBankApi\Model\GetQrBankListDevice',
        'token' => 'string'
    ];
    ...
    public const SCENARIO_TYPE_QR = 'qr';
    public const SCENARIO_TYPE_SUB = 'sub';
     ...
     * @return string[]
     */
    public function getScenarioTypeAllowableValues()
    {
        return [
            self::SCENARIO_TYPE_QR,
            self::SCENARIO_TYPE_SUB,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('scenario_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['terminal_key']) > 64)) {
            $invalidProperties[] = "invalid value for 'terminal_key', the character length must be smaller than or equal to 64.";
        }

        $allowedValues = $this->getScenarioTypeAllowableValues();
        if (!is_null($this->container['scenario_type']) && !in_array($this->container['scenario_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'scenario_type', must be one of '%s'",
                $this->container['scenario_type'],
    ...
    {
        if ((mb_strlen($terminal_key) > 64)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling GetQrBankList., must be smaller than or equal to 64.');
        }
     ...
     * Sets scenario_type
     *
     * @param string|null $scenario_type Тип сценария оплаты. * `qr` - оплата;     * `sub` - привязка счета.  Значение по умолчанию — `qr`.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getScenarioTypeAllowableValues();
        if (!is_null($scenario_type) && !in_array($scenario_type, $allowedValues, true)) {
        ...
        if (is_null($scenario_type)) {
            throw new \InvalidArgumentException('non-nullable scenario_type cannot be null');
        }
     ...
     * Gets device
     *
     * @return \RoxlTBankApi\Model\GetQrBankListDevice
     */
     ...
     * Sets device
     *
     * @param \RoxlTBankApi\Model\GetQrBankListDevice $device device
     *
     * @return self
     */
    ...
    public function setToken($token)
    {
        if ((mb_strlen($token) > 255)) {
            throw new \InvalidArgumentException('invalid length for $token when calling GetQrBankList., must be smaller than or equal to 255.');
        }
