...
/**
 * GetTerminalPayMethods Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class GetTerminalPayMethods implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTerminalPayMethods';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('paysource', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['paysource'] === null) {
            $invalidProperties[] = "'paysource' can't be null";
        }
    ...
    {
        return $this->container['paysource'];
    }

    /**
     * Sets paysource
     *
     * @param string $paysource Тип подключения:    - API;    - SDK.
     *
     * @return self
     */
    public function setPaysource($paysource)
    {
        if (is_null($paysource)) {
            throw new \InvalidArgumentException('non-nullable paysource cannot be null');
        }
        $this->container['paysource'] = $paysource;
