 ...
 */
class GetTerminalPayMethodsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTerminalPayMethodsResponse';
    ...
    protected static $openAPITypes = [
        ...
        'terminal_info_paymethods' => '\RoxlTBankApi\Model\Paymethod[]',
    ...
    protected static $openAPIFormats = [
        ...
        'details' => null,
        'terminal_info' => null,
        'terminal_info_paymethods' => null,
        'terminal_info_add_card_scheme' => null,
        'terminal_info_token_required' => null,
        'terminal_info_init_token_required' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'details' => false,
		'terminal_info' => false,
		'terminal_info_paymethods' => false,
		'terminal_info_add_card_scheme' => false,
		'terminal_info_token_required' => false,
		'terminal_info_init_token_required' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'terminal_info_paymethods' => 'TerminalInfo.Paymethods',
        'terminal_info_add_card_scheme' => 'TerminalInfo.AddCardScheme',
        'terminal_info_token_required' => 'TerminalInfo.TokenRequired',
        'terminal_info_init_token_required' => 'TerminalInfo.InitTokenRequired'
    ];
    ...
    protected static $setters = [
        ...
        'message' => 'setMessage',
        'details' => 'setDetails',
        'terminal_info' => 'setTerminalInfo',
        'terminal_info_paymethods' => 'setTerminalInfoPaymethods',
        'terminal_info_add_card_scheme' => 'setTerminalInfoAddCardScheme',
        'terminal_info_token_required' => 'setTerminalInfoTokenRequired',
        'terminal_info_init_token_required' => 'setTerminalInfoInitTokenRequired'
    ];
    ...
    protected static $getters = [
        ...
        'terminal_info_paymethods' => 'getTerminalInfoPaymethods',
        'terminal_info_add_card_scheme' => 'getTerminalInfoAddCardScheme',
        'terminal_info_token_required' => 'getTerminalInfoTokenRequired',
        'terminal_info_init_token_required' => 'getTerminalInfoInitTokenRequired'
    ];
    ...
    public const TERMINAL_INFO_ADD_CARD_SCHEME_TRUE = 'true';
    public const TERMINAL_INFO_ADD_CARD_SCHEME_FALSE = 'false';
    public const TERMINAL_INFO_TOKEN_REQUIRED_TRUE = 'true';
    public const TERMINAL_INFO_TOKEN_REQUIRED_FALSE = 'false';
    public const TERMINAL_INFO_INIT_TOKEN_REQUIRED_TRUE = 'true';
    public const TERMINAL_INFO_INIT_TOKEN_REQUIRED_FALSE = 'false';
     ...
     * @return string[]
     */
    public function getTerminalInfoAddCardSchemeAllowableValues()
    {
        return [
            self::TERMINAL_INFO_ADD_CARD_SCHEME_TRUE,
            self::TERMINAL_INFO_ADD_CARD_SCHEME_FALSE,
        ];
    }
     ...
     * @return string[]
     */
    public function getTerminalInfoTokenRequiredAllowableValues()
    {
        return [
            self::TERMINAL_INFO_TOKEN_REQUIRED_TRUE,
            self::TERMINAL_INFO_TOKEN_REQUIRED_FALSE,
        ];
    }
     ...
     * @return string[]
     */
    public function getTerminalInfoInitTokenRequiredAllowableValues()
    {
        return [
            self::TERMINAL_INFO_INIT_TOKEN_REQUIRED_TRUE,
            self::TERMINAL_INFO_INIT_TOKEN_REQUIRED_FALSE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('terminal_info', $data ?? [], null);
        $this->setIfExists('terminal_info_paymethods', $data ?? [], null);
        $this->setIfExists('terminal_info_add_card_scheme', $data ?? [], null);
        $this->setIfExists('terminal_info_token_required', $data ?? [], null);
        $this->setIfExists('terminal_info_init_token_required', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['terminal_info'] === null) {
            $invalidProperties[] = "'terminal_info' can't be null";
        }
        if ($this->container['terminal_info_add_card_scheme'] === null) {
            $invalidProperties[] = "'terminal_info_add_card_scheme' can't be null";
        }
        $allowedValues = $this->getTerminalInfoAddCardSchemeAllowableValues();
        if (!is_null($this->container['terminal_info_add_card_scheme']) && !in_array($this->container['terminal_info_add_card_scheme'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'terminal_info_add_card_scheme', must be one of '%s'",
                $this->container['terminal_info_add_card_scheme'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['terminal_info_token_required'] === null) {
            $invalidProperties[] = "'terminal_info_token_required' can't be null";
        }
        $allowedValues = $this->getTerminalInfoTokenRequiredAllowableValues();
        if (!is_null($this->container['terminal_info_token_required']) && !in_array($this->container['terminal_info_token_required'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'terminal_info_token_required', must be one of '%s'",
                $this->container['terminal_info_token_required'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['terminal_info_init_token_required'] === null) {
            $invalidProperties[] = "'terminal_info_init_token_required' can't be null";
        }
        $allowedValues = $this->getTerminalInfoInitTokenRequiredAllowableValues();
        if (!is_null($this->container['terminal_info_init_token_required']) && !in_array($this->container['terminal_info_init_token_required'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'terminal_info_init_token_required', must be one of '%s'",
                $this->container['terminal_info_init_token_required'],
                implode("', '", $allowedValues)
            );
        }
    ...
    {
        return $this->container['terminal_info'];
    }

    /**
     * Sets terminal_info
     *
     * @param object $terminal_info Характеристики терминала.
     *
     * @return self
     */
    public function setTerminalInfo($terminal_info)
    {

        if (is_null($terminal_info)) {
            throw new \InvalidArgumentException('non-nullable terminal_info cannot be null');
        }

        $this->container['terminal_info'] = $terminal_info;
     ...
     *
     * @return \RoxlTBankApi\Model\Paymethod[]|null
     */
    public function getTerminalInfoPaymethods()
    {
        return $this->container['terminal_info_paymethods'];
    }

    /**
     * Sets terminal_info_paymethods
     *
     * @param \RoxlTBankApi\Model\Paymethod[]|null $terminal_info_paymethods Перечень доступных методов оплаты.
     *
     * @return self
     */
    public function setTerminalInfoPaymethods($terminal_info_paymethods)
    {

        if (is_null($terminal_info_paymethods)) {
            throw new \InvalidArgumentException('non-nullable terminal_info_paymethods cannot be null');
        }

        $this->container['terminal_info_paymethods'] = $terminal_info_paymethods;

        return $this;
    }

    /**
     * Gets terminal_info_add_card_scheme
     *
     * @return bool
     */
    public function getTerminalInfoAddCardScheme()
    {
        return $this->container['terminal_info_add_card_scheme'];
    }

    /**
     * Sets terminal_info_add_card_scheme
     *
     * @param bool $terminal_info_add_card_scheme Признак возможности сохранения карт.
     *
     * @return self
     */
    public function setTerminalInfoAddCardScheme($terminal_info_add_card_scheme)
    {
        $allowedValues = $this->getTerminalInfoAddCardSchemeAllowableValues();
        if (!in_array($terminal_info_add_card_scheme, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'terminal_info_add_card_scheme', must be one of '%s'",
                    $terminal_info_add_card_scheme,
                    implode("', '", $allowedValues)
                )
            );
        }

        if (is_null($terminal_info_add_card_scheme)) {
            throw new \InvalidArgumentException('non-nullable terminal_info_add_card_scheme cannot be null');
        }

        $this->container['terminal_info_add_card_scheme'] = $terminal_info_add_card_scheme;

        return $this;
    }

    /**
     * Gets terminal_info_token_required
     *
     * @return bool
     */
    public function getTerminalInfoTokenRequired()
    {
        return $this->container['terminal_info_token_required'];
    }

    /**
     * Sets terminal_info_token_required
     *
     * @param bool $terminal_info_token_required Признак необходимости подписания токеном.
     *
     * @return self
     */
    public function setTerminalInfoTokenRequired($terminal_info_token_required)
    {
        $allowedValues = $this->getTerminalInfoTokenRequiredAllowableValues();
        if (!in_array($terminal_info_token_required, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'terminal_info_token_required', must be one of '%s'",
                    $terminal_info_token_required,
                    implode("', '", $allowedValues)
                )
            );
        }

        if (is_null($terminal_info_token_required)) {
            throw new \InvalidArgumentException('non-nullable terminal_info_token_required cannot be null');
        }

        $this->container['terminal_info_token_required'] = $terminal_info_token_required;

        return $this;
    }

    /**
     * Gets terminal_info_init_token_required
     *
     * @return bool
     */
    public function getTerminalInfoInitTokenRequired()
    {
        return $this->container['terminal_info_init_token_required'];
    }

    /**
     * Sets terminal_info_init_token_required
     *
     * @param bool $terminal_info_init_token_required Признак необходимости подписания токеном запроса **Init**.
     *
     * @return self
     */
    public function setTerminalInfoInitTokenRequired($terminal_info_init_token_required)
    {
        $allowedValues = $this->getTerminalInfoInitTokenRequiredAllowableValues();
        if (!in_array($terminal_info_init_token_required, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'terminal_info_init_token_required', must be one of '%s'",
                    $terminal_info_init_token_required,
                    implode("', '", $allowedValues)
                )
            );
        }

        if (is_null($terminal_info_init_token_required)) {
            throw new \InvalidArgumentException('non-nullable terminal_info_init_token_required cannot be null');
        }

        $this->container['terminal_info_init_token_required'] = $terminal_info_init_token_required;
