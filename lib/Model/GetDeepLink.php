 ...
 */
class GetDeepLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetDeepLink';
    ...
    */
     ...
     * Sets payment_id
     *
     * @param string $payment_id Уникальный идентификатор транзакции в системе Банка.
     *
     * @return self
     */
