...
/**
 * GetQrStateRequest Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class GetQrStateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQrState_request';
    ...
    */
     ...
     * Sets payment_id
     *
     * @param string $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес, полученный в ответе на вызов метода Init
     *
     * @return self
     */
