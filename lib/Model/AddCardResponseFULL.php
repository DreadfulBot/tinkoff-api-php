...
/**
 * AddCardResponseFULL Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddCardResponseFULL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddCardResponse_FULL';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['payment_url']) > 100)) {
     ...
     * Sets payment_id
     *
     * @param float $payment_id Идентификатор платежа в системе Т‑Бизнес.
     *
     * @return self
     */
     ...
     * Sets terminal_key
     *
     * @param string $terminal_key Идентификатор терминала. Выдается мерчанту Т‑Бизнес при заведении терминала.
     *
     * @return self
     */
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling AddCardResponseFULL., must be smaller than or equal to 20.');
        }
    ...
    public function setCustomerKey($customer_key)
    {
        ...
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling AddCardResponseFULL., must be smaller than or equal to 36.');
        }
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling AddCardResponseFULL., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling AddCardResponseFULL., must be smaller than or equal to 255.');
        }
     ...
     * Sets payment_url
     *
     * @param string $payment_url UUID, используется для работы без PCI DSS.
     *
     * @return self
     */
    public function setPaymentUrl($payment_url)
    {
        ...
        if ((mb_strlen($payment_url) > 100)) {
            throw new \InvalidArgumentException('invalid length for $payment_url when calling AddCardResponseFULL., must be smaller than or equal to 100.');
        }
