 ...
 */
class Cancel2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cancel-2';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['new_amount'] === null) {
            $invalidProperties[] = "'new_amount' can't be null";
        }
     ...
     *
     * @param float $original_amount Сумма в копейках до операции отмены.
     *
     * @return self
     */
     ...
     * Sets new_amount
     *
     * @param float $new_amount Сумма в копейках после операции отмены.
     *
     * @return self
     */
     ...
     * Sets payment_id
     *
     * @param float $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес.
     *
     * @return self
     */
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling Cancel2., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string|null $external_request_id Идентификатор операции на стороне мерчанта.
     *
     * @return self
     */
