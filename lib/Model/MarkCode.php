 ...
 */
class MarkCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarkCode';
    ...
    protected static $setters = [
        'mark_code_type' => 'setMarkCodeType',
        'value' => 'setValue'
    ];
    ...
    protected static $getters = [
        'mark_code_type' => 'getMarkCodeType',
        'value' => 'getValue'
    ];
    ...
    {
        $this->setIfExists('mark_code_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mark_code_type'] === null) {
            $invalidProperties[] = "'mark_code_type' can't be null";
        }
