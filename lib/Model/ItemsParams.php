 ...
 */
class ItemsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Items_Params';
    ...
    public const KEY_CREDIT_AMOUNT = 'CreditAmount';
    public const VALUE_ACQ = 'ACQ';
    public const VALUE_BNPL = 'BNPL';
    public const VALUE_TCB = 'TCB';
    public const VALUE_SBER = 'SBER';
    public const VALUE_BNPL2 = 'BNPL';
    public const VALUE_CARDS = 'cards';
    public const VALUE_INSTALLMENT = 'Installment';
    public const VALUE_MIR_PAY = 'MirPay';
    public const VALUE_QRSBP = 'qrsbp';
    public const VALUE_SBER_PAY = 'SberPay';
    public const VALUE_TINKOFF_PAY = 'TinkoffPay';
    public const VALUE_YANDEX_PAY = 'YandexPay';
    ...
    public function getValueAllowableValues()
    {
        return [
            ...
            self::VALUE_QRSBP,
            self::VALUE_SBER_PAY,
            self::VALUE_TINKOFF_PAY,
            self::VALUE_YANDEX_PAY,
        ];
    }
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key Возможные значения: * `Route` — способ оплаты. * `Source` — источник платежа. * `CreditAmount` — сумма выданного кредита в копейках. Возвращается только для платежей в рассрочку.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Возможные значения: * `ACQ`, `BNPL`, `TCB`, `SBER` — для Route. * `BNPL`, `cards`, `Installment`, `MirPay`, `qrsbp`, `SberPay`, `TinkoffPay`, `YandexPay` — для Source. * Сумма в копейках — для CreditAmount.
     *
     * @return self
     */
