 ...
 */
class LongPay1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LongPay1';
    ...
    protected static $openAPITypes = [
        ...
        'ticket_reservation_number' => 'string',
        'ticket_system' => 'string',
        'ticket_agency_code' => 'string',
        'ticket_agency_name' => 'string',
    ...
    protected static $openAPIFormats = [
        'ticket_number' => null,
        'ticket_reservation_number' => null,
        'ticket_system' => null,
        'ticket_agency_code' => null,
        'ticket_agency_name' => null,
        'ticket_restricted' => null
    ];
    ...
    protected static array $openAPINullables = [
        'ticket_number' => false,
		'ticket_reservation_number' => false,
		'ticket_system' => false,
		'ticket_agency_code' => false,
		'ticket_agency_name' => false,
    ...
    protected static $attributeMap = [
        ...
        'ticket_reservation_number' => 'ticketReservationNumber',
        'ticket_system' => 'ticketSystem',
        'ticket_agency_code' => 'ticketAgencyCode',
        'ticket_agency_name' => 'ticketAgencyName',
        'ticket_restricted' => 'ticketRestricted'
    ];
    ...
    protected static $setters = [
        ...
        'ticket_reservation_number' => 'setTicketReservationNumber',
        'ticket_system' => 'setTicketSystem',
        'ticket_agency_code' => 'setTicketAgencyCode',
        'ticket_agency_name' => 'setTicketAgencyName',
        'ticket_restricted' => 'setTicketRestricted'
    ];
    ...
    protected static $getters = [
        ...
        'ticket_reservation_number' => 'getTicketReservationNumber',
        'ticket_system' => 'getTicketSystem',
        'ticket_agency_code' => 'getTicketAgencyCode',
        'ticket_agency_name' => 'getTicketAgencyName',
        'ticket_restricted' => 'getTicketRestricted'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ticket_reservation_number', $data ?? [], null);
        $this->setIfExists('ticket_system', $data ?? [], null);
        $this->setIfExists('ticket_agency_code', $data ?? [], null);
        $this->setIfExists('ticket_agency_name', $data ?? [], null);
        $this->setIfExists('ticket_restricted', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets ticket_number
     *
     * @param string|null $ticket_number Номера билетов с контрольной цифрой для всех пассажиров, летящих по одному маршруту. В качестве разделителя используйте `;`.  Необязателен, если передан параметр `ticketReservationNumber`.
     *
     * @return self
     */
    ...
    /**
     * Gets ticket_reservation_number
     *
     * @return string|null
     */
    public function getTicketReservationNumber()
    {
        return $this->container['ticket_reservation_number'];
    }

    /**
     * Sets ticket_reservation_number
     *
     * @param string|null $ticket_reservation_number Номера билетов с контрольной цифрой для всех пассажиров, летящих по одному маршруту. В качестве разделителя используйте `;`.  Необязателен, если передан параметр `ticketNumber`.
     *
     * @return self
     */
    public function setTicketReservationNumber($ticket_reservation_number)
    {

        if (is_null($ticket_reservation_number)) {
            throw new \InvalidArgumentException('non-nullable ticket_reservation_number cannot be null');
        }

        $this->container['ticket_reservation_number'] = $ticket_reservation_number;
    ...
    {
        return $this->container['ticket_system'];
    }

    /**
     * Sets ticket_system
     *
     * @param string|null $ticket_system Код системы продажи.
     *
     * @return self
     */
    public function setTicketSystem($ticket_system)
    {

        if (is_null($ticket_system)) {
            throw new \InvalidArgumentException('non-nullable ticket_system cannot be null');
        }

        $this->container['ticket_system'] = $ticket_system;

        return $this;
    }

    /**
     * Gets ticket_agency_code
     *
     * @return string|null
     */
    public function getTicketAgencyCode()
    {
        return $this->container['ticket_agency_code'];
    }

    /**
     * Sets ticket_agency_code
     *
     * @param string|null $ticket_agency_code Код агентства.
     *
     * @return self
     */
    public function setTicketAgencyCode($ticket_agency_code)
    {

        if (is_null($ticket_agency_code)) {
            throw new \InvalidArgumentException('non-nullable ticket_agency_code cannot be null');
        }

        $this->container['ticket_agency_code'] = $ticket_agency_code;

        return $this;
    }

    /**
     * Gets ticket_agency_name
     *
     * @return string|null
     */
    public function getTicketAgencyName()
    {
        return $this->container['ticket_agency_name'];
    }

    /**
     * Sets ticket_agency_name
     *
     * @param string|null $ticket_agency_name Название агентства.
     *
     * @return self
     */
    public function setTicketAgencyName($ticket_agency_name)
    {

        if (is_null($ticket_agency_name)) {
            throw new \InvalidArgumentException('non-nullable ticket_agency_name cannot be null');
        }

        $this->container['ticket_agency_name'] = $ticket_agency_name;

        return $this;
    }

    /**
     * Gets ticket_restricted
     *
     * @return string|null
     */
    public function getTicketRestricted()
    {
        return $this->container['ticket_restricted'];
    }

    /**
     * Sets ticket_restricted
     *
     * @param string|null $ticket_restricted Ограничения билета: * `0` — без ограничений, * `1` — невозвратный.
     *
     * @return self
     */
    public function setTicketRestricted($ticket_restricted)
    {

        if (is_null($ticket_restricted)) {
            throw new \InvalidArgumentException('non-nullable ticket_restricted cannot be null');
        }

        $this->container['ticket_restricted'] = $ticket_restricted;
