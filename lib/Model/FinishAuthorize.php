...
/**
 * FinishAuthorize Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class FinishAuthorize implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinishAuthorize';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling FinishAuthorize., must be smaller than or equal to 20.');
        }
    ...
    public function setOrderId($order_id)
    {
        if ((mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling FinishAuthorize., must be smaller than or equal to 36.');
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FinishAuthorize., must be smaller than or equal to 20.');
        }
    ...
    public function setPaymentId($payment_id)
    {
        if (!is_null($payment_id) && (mb_strlen($payment_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling FinishAuthorize., must be smaller than or equal to 20.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling FinishAuthorize., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling FinishAuthorize., must be smaller than or equal to 255.');
        }
