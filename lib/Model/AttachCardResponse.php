...
/**
 * AttachCardResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AttachCardResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttachCardResponse';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling AttachCardResponse., must be smaller than or equal to 20.');
        }
     ...
     * Sets card_id
     *
     * @param string|null $card_id Идентификатор карты в системе Т‑Бизнес. <br> При сценарии 3-D Secure Authentication Challenge — `CardId` можно получить после успешного прохождения 3DS.
     *
     * @return self
     */
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling AttachCardResponse., must be smaller than or equal to 20.');
        }
     ...
     * Sets status
     *
     * @param string|null $status Статус привязки карты: * `NEW` — новая сессия привязки карты; * `FORM_SHOWED` — показ формы привязки карты; * `THREE_DS_CHECKING` — отправка клиента на проверку 3DS; * `THREE_DS_CHECKED` — клиент успешно прошел проверку 3DS; * `AUTHORIZING` — отправка платежа на 0 руб; * `AUTHORIZED` — платеж на 0 руб прошел успешно; * `COMPLETED` — карта успешно привязана; * `REJECTED` — привязать карту не удалось.
     *
     * @return self
     */
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling AttachCardResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling AttachCardResponse., must be smaller than or equal to 255.');
        }
     ...
     * Sets acs_url
     *
     * @param string|null $acs_url Адрес сервера управления доступом для проверки 3DS — возвращается в ответе на статус `3DS_CHECKING`.
     *
     * @return self
     */
     ...
     * Sets md
     *
     * @param string|null $md Уникальный идентификатор транзакции в системе Т‑Бизнес — возвращается в ответе на статус `3DS_CHECKING`.
     *
     * @return self
     */
     ...
     * Sets pa_req
     *
     * @param string|null $pa_req Результат аутентификации 3-D Secure — возвращается в ответе на статус `3DS_CHECKING`.
     *
     * @return self
     */
