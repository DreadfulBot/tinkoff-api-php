 ...
 */
class QrMembersList200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QrMembersList_200_response';
    ...
    protected static $openAPITypes = [
        'members' => '\RoxlTBankApi\Model\Member[]',
        'order_id' => 'string',
        'success' => 'bool',
        'error_code' => 'string',
        'message' => 'string'
    ...
    */
     ...
     * Gets members
     *
     * @return \RoxlTBankApi\Model\Member[]|null
     */
     ...
     * Sets members
     *
     * @param \RoxlTBankApi\Model\Member[]|null $members Массив списка участников. Возвращается, только если возврат возможен.
     *
     * @return self
     */
    ...
    public function setOrderId($order_id)
    {
        if ((mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling QrMembersList200Response., must be smaller than or equal to 36.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling QrMembersList200Response., must be smaller than or equal to 20.');
        }
