...
/**
 * RemoveCardResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RemoveCardResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoveCardResponse';
    ...
    public const CARD_TYPE_NUMBER_0 = 0;
    public const CARD_TYPE_NUMBER_1 = 1;
    public const CARD_TYPE_NUMBER_2 = 2;
    ...
    {
        return [
            self::CARD_TYPE_NUMBER_0,
            self::CARD_TYPE_NUMBER_1,
            self::CARD_TYPE_NUMBER_2,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['status']) > 100)) {
        ...
        if ((mb_strlen($this->container['customer_key']) > 36)) {
        ...
        if ((mb_strlen($this->container['card_id']) > 40)) {
        ...
        if ((mb_strlen($this->container['error_code']) > 15)) {
            $invalidProperties[] = "invalid value for 'error_code', the character length must be smaller than or equal to 15.";
        }
    ...
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling RemoveCardResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) > 100)) {
            throw new \InvalidArgumentException('invalid length for $status when calling RemoveCardResponse., must be smaller than or equal to 100.');
        }
     ...
     * Sets customer_key
     *
     * @param string $customer_key Идентификатор клиента в системе мерчанта.
     *
     * @return self
     */
    public function setCustomerKey($customer_key)
    {
        ...
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling RemoveCardResponse., must be smaller than or equal to 36.');
        }
     ...
     * Sets card_id
     *
     * @param string $card_id Идентификатор карты в системе Т‑Бизнес.
     *
     * @return self
     */
    public function setCardId($card_id)
    {
        ...
        if ((mb_strlen($card_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $card_id when calling RemoveCardResponse., must be smaller than or equal to 40.');
        }
     ...
     * Sets card_type
     *
     * @param float $card_type Тип карты: * `0` — карта списания, * `1` — карта пополнения, * `2` — карта пополнения и списания.
     *
     * @return self
     */
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 15)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling RemoveCardResponse., must be smaller than or equal to 15.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling RemoveCardResponse., must be smaller than or equal to 255.');
        }
