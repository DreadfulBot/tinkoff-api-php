...
/**
 * PaymentIdListForGCO Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentIdListForGCO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentIdListForGCO';
    ...
    */
     ...
     * Sets message
     *
     * @param string $message Сервисное сообщение.
     *
     * @return self
     */
     ...
     * Sets payment_id
     *
     * @param float $payment_id Идентификатор операции.
     *
     * @return self
     */
