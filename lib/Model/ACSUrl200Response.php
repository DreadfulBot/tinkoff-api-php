 ...
 */
class ACSUrl200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ACSUrl_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'cres' => '\RoxlTBankApi\Model\ChallengeRequestCReq1'
    ];
    ...
    protected static $attributeMap = [
        'md' => 'MD',
        'pa_res' => 'PaRes',
        'fallback_on_tds_v1' => 'FallbackOnTdsV1',
        'cres' => 'cres'
    ];
    ...
    protected static $setters = [
        'md' => 'setMd',
        'pa_res' => 'setPaRes',
        'fallback_on_tds_v1' => 'setFallbackOnTdsV1',
        'cres' => 'setCres'
    ];
    ...
    protected static $getters = [
        'md' => 'getMd',
        'pa_res' => 'getPaRes',
        'fallback_on_tds_v1' => 'getFallbackOnTdsV1',
        'cres' => 'getCres'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fallback_on_tds_v1', $data ?? [], null);
    ...
    */
     ...
     * Sets md
     *
     * @param string $md Уникальный идентификатор транзакции в системе Банка (возвращается в ответе на FinishAuthorize)
     *
     * @return self
     */
     ...
     * Sets pa_res
     *
     * @param string $pa_res Шифрованная строка, содержащая результаты 3-D Secure аутентификации (возвращается в ответе от ACS)
     *
     * @return self
     */
    ...
    /**
     * Gets fallback_on_tds_v1
     *
     * @return string|null
     */
    public function getFallbackOnTdsV1()
    {
        return $this->container['fallback_on_tds_v1'];
    }

    /**
     * Sets fallback_on_tds_v1
     *
     * @param string|null $fallback_on_tds_v1 В случае невозможности прохождения аутентификации по 3DS v2.1, делается принудительный Fallback на 3DS v1.0 и данный атрибут выставляется в true, в противном случае не передается в ответе
     *
     * @return self
     */
    public function setFallbackOnTdsV1($fallback_on_tds_v1)
    {

        if (is_null($fallback_on_tds_v1)) {
            throw new \InvalidArgumentException('non-nullable fallback_on_tds_v1 cannot be null');
        }

        $this->container['fallback_on_tds_v1'] = $fallback_on_tds_v1;
     ...
     * Gets cres
     *
     * @return \RoxlTBankApi\Model\ChallengeRequestCReq1
     */
     ...
     * Sets cres
     *
     * @param \RoxlTBankApi\Model\ChallengeRequestCReq1 $cres cres
     *
     * @return self
     */
