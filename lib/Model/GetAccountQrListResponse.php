 ...
 */
class GetAccountQrListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'error_code' => 'string',
        'message' => 'string',
        'account_tokens' => '\RoxlTBankApi\Model\GetAccountQrListResponseAccountTokensInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('account_tokens', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets account_tokens
     *
     * @return \RoxlTBankApi\Model\GetAccountQrListResponseAccountTokensInner[]|null
     */
     ...
     * Sets account_tokens
     *
     * @param \RoxlTBankApi\Model\GetAccountQrListResponseAccountTokensInner[]|null $account_tokens Список привязанных счетов покупателя по магазину.
     *
     * @return self
     */
    public function setAccountTokens($account_tokens)
    {
        ...
        if (is_null($account_tokens)) {
            throw new \InvalidArgumentException('non-nullable account_tokens cannot be null');
        }
