 ...
 */
class Status200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Status_200_response';
    ...
    protected static $openAPITypes = [
        'params' => '\RoxlTBankApi\Model\Status200ResponseParams',
        'success' => 'bool',
        'error_code' => 'string',
        'message' => 'string',
        'details' => 'string'
    ...
    */
     ...
     * Gets params
     *
     * @return \RoxlTBankApi\Model\Status200ResponseParams
     */
     ...
     * Sets params
     *
     * @param \RoxlTBankApi\Model\Status200ResponseParams $params params
     *
     * @return self
     */
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling Status200Response., must be smaller than or equal to 20.');
        }
