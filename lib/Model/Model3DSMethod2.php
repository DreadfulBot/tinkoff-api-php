...
/**
 * Model3DSMethod2 Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class Model3DSMethod2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '3DSMethod-2';
    ...
    */
     ...
     *
     * @param string $three_ds_server_trans_id Идентификатор транзакции
     *
     * @return self
     */
