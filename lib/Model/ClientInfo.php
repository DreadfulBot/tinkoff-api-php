...
class ClientInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('document_code', $data ?? [], null);
    ...
    */
     ...
     * Sets birthdate
     *
     * @param string|null $birthdate `Тег ФФД: 1243`   Дата рождения клиента в формате `ДД.ММ.ГГГГ`.
     *
     * @return self
     */
     ...
     * Sets citizenship
     *
     * @param string|null $citizenship `Тег ФФД: 1244`   Числовой код страны, гражданином которой является клиент. Код страны указывается в соответствии с Общероссийским классификатором стран мира [ОКСМ](https://classifikators.ru/oksm).
     *
     * @return self
     */
     ...
     * Sets document_data
     *
     * @param string|null $document_data `Тег ФФД: 1246`   Реквизиты документа, удостоверяющего личность — например, серия и номер паспорта.
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address `Тег ФФД: 1254`   Адрес клиента-грузополучателя.
     *
     * @return self
     */
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 256)) {
            throw new \InvalidArgumentException('invalid length for $address when calling ClientInfo., must be smaller than or equal to 256.');
        }
