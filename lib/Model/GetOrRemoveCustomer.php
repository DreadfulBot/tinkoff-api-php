...
/**
 * GetOrRemoveCustomer Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class GetOrRemoveCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrRemoveCustomer';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling GetOrRemoveCustomer., must be smaller than or equal to 20.');
        }
    ...
    public function setCustomerKey($customer_key)
    {
        if ((mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling GetOrRemoveCustomer., must be smaller than or equal to 36.');
        }
    ...
    public function setIp($ip)
    {
        if (!is_null($ip) && (mb_strlen($ip) > 40)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling GetOrRemoveCustomer., must be smaller than or equal to 40.');
        }
