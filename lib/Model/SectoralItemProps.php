...
/**
 * SectoralItemProps Class Doc Comment
 *
 * @category Class
 * @description Отраслевой реквизит предмета расчета. Указывается только для товаров подлежащих обязательной маркировке средством идентификации. Включение этого реквизита предусмотрено НПА отраслевого регулирования для соответствующей товарной группы.
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SectoralItemProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SectoralItemProps';
    ...
    */
     ...
     * Sets federal_id
     *
     * @param string $federal_id `Тег ФФД: 1262`   Идентификатор ФОИВ — федеральный орган исполнительной власти.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime $date `Тег ФФД: 1263`   Дата нормативного акта ФОИВ.
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string $number `Тег ФФД: 1264`   Номер нормативного акта ФОИВ.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value `Тег ФФД: 1265`   Состав значений, определенных нормативным актом ФОИВ.
     *
     * @return self
     */
