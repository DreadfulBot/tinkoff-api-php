...
class Member implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_payee', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_payee'] === null) {
            $invalidProperties[] = "'is_payee' can't be null";
        }
     ...
     * Sets member_id
     *
     * @param string $member_id Идентификатор участника.
     *
     * @return self
     */
     ...
     * Sets member_name
     *
     * @param string $member_name Наименование участника.
     *
     * @return self
     */
     ...
     * @return bool
     */
    public function getIsPayee()
    {
        return $this->container['is_payee'];
    }

    /**
     * Sets is_payee
     *
     * @param bool $is_payee * `true` — если данный участник был получателем указанного платежа,  * `false` — если нет.
     *
     * @return self
     */
    public function setIsPayee($is_payee)
    {

        if (is_null($is_payee)) {
            throw new \InvalidArgumentException('non-nullable is_payee cannot be null');
        }

        $this->container['is_payee'] = $is_payee;
