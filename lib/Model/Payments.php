...
class Payments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('advance_payment', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['electronic'] === null) {
            $invalidProperties[] = "'electronic' can't be null";
        }
     ...
     * Sets cash
     *
     * @param float|null $cash `Тег ФФД: 1031.`<br>  Вид оплаты «Наличные». Сумма к оплате в копейках.
     *
     * @return self
     */
     ...
     * Sets electronic
     *
     * @param float $electronic `Тег ФФД: 1081.`<br>  Вид оплаты «Безналичный».
     *
     * @return self
     */
     ...
     *
     * @param float|null $advance_payment `Тег ФФД: 1215.`<br>  Вид оплаты «Предварительная оплата (Аванс)».
     *
     * @return self
     */
    public function setAdvancePayment($advance_payment)
    {
        if (is_null($advance_payment)) {
            throw new \InvalidArgumentException('non-nullable advance_payment cannot be null');
        }
     ...
     * Sets credit
     *
     * @param float|null $credit `Тег ФФД: 1216.`<br>  Вид оплаты «Постоплата (Кредит)».
     *
     * @return self
     */
     ...
     * Sets provision
     *
     * @param float|null $provision `Тег ФФД: 1217.`<br>  Вид оплаты «Иная форма оплаты».
     *
     * @return self
     */
