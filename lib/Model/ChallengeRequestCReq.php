...
/**
 * ChallengeRequestCReq Class Doc Comment
 *
 * @category Class
 ...
 */
class ChallengeRequestCReq implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Challenge_Request__CReq_';
    ...
    */
     ...
     *
     * @param string $challenge_window_size Размер экрана, на котором открыта страница ACS. <br>Допустимые значения <br>• 01 = 250 x 400, <br>• 02 = 390 x 400, <br>• 03 = 500 x 600, <br>• 04 = 600 x 400, <br>• 05 = Fullscreen. <br>
     *
     * @return self
     */
     ...
     * Sets message_type
     *
     * @param string $message_type Передается фиксированное значение «CReq»
     *
     * @return self
     */
     ...
     *
     * @param string $message_version Версия 3DS, полученная из ответа метода Check3dsVersion
     *
     * @return self
     */
