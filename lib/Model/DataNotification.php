...
/**
 * DataNotification Class Doc Comment
 *
 * @category Class
 ...
 */
class DataNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataNotification';
    ...
    */
     ...
     * Sets credit_amount
     *
     * @param float|null $credit_amount Сумма выданного кредита в копейках. Возвращается только для платежей в рассрочку, если в запросе [Confirm](https://www.tbank.ru/kassa/dev/payments/#tag/Dvuhstadijnyj-platezh/operation/Confirm) был передан параметр `Source` в значении `Installment`.
     *
     * @return self
     */
