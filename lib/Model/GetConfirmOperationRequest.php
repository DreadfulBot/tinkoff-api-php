...
/**
 * GetConfirmOperationRequest Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class GetConfirmOperationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetConfirmOperation_request';
    ...
    protected static $setters = [
        ...
        'payment_id_list' => 'setPaymentIdList',
        'token' => 'setToken',
    ...
    protected static $getters = [
        ...
        'payment_id_list' => 'getPaymentIdList',
        'token' => 'getToken',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('payment_id_list', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_id_list'] === null) {
            $invalidProperties[] = "'payment_id_list' can't be null";
        }
     ...
     * Sets callback_url
     *
     * @param string $callback_url URL сервиса получения справок.
     *
     * @return self
     */
    ...
    {
        return $this->container['payment_id_list'];
    }

    /**
     * Sets payment_id_list
     *
     * @param float[] $payment_id_list JSON-массив, содержащий в себе перечень `paymentID` (уникальных идентификаторов в системе Т‑Бизнес) c типом `Number`.
     *
     * @return self
     */
    public function setPaymentIdList($payment_id_list)
    {
        if (is_null($payment_id_list)) {
            throw new \InvalidArgumentException('non-nullable payment_id_list cannot be null');
        }
        $this->container['payment_id_list'] = $payment_id_list;
     ...
     * Sets email_list
     *
     * @param string[] $email_list JSON-массив, содержащий перечень `Email` с типом `String`.
     *
     * @return self
     */
