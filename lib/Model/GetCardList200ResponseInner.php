...
/**
 * GetCardList200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class GetCardList200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCardList_200_response_inner';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Статус карты: * A — активная,   * D — удаленная.
     *
     * @return self
     */
     ...
     * Sets card_type
     *
     * @param float $card_type Тип карты: * карта списания (0), * карта пополнения (1), * карта пополнения и списания (2).
     *
     * @return self
     */
     ...
     * Sets exp_date
     *
     * @param string|null $exp_date Срок действия карты
     *
     * @return self
     */
