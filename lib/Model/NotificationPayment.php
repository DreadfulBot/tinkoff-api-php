 ...
 */
class NotificationPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationPayment';
    ...
    protected static $openAPITypes = [
        ...
        'exp_date' => 'string',
        'token' => 'string',
        'data' => '\RoxlTBankApi\Model\DataNotification'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['terminal_key']) && (mb_strlen($this->container['terminal_key']) > 20)) {
     ...
     * Sets terminal_key
     *
     * @param string|null $terminal_key Идентификатор терминала. Выдается мерчанту в Т‑Бизнес при заведении терминала.
     *
     * @return self
     */
    public function setTerminalKey($terminal_key)
    {
        if (!is_null($terminal_key) && (mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling NotificationPayment., must be smaller than or equal to 20.');
        }
    ...
    public function setOrderId($order_id)
    {
        if (!is_null($order_id) && (mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling NotificationPayment., must be smaller than or equal to 36.');
        }
     ...
     * Sets success
     *
     * @param bool|null $success Успешность прохождения запроса — `true`/`false`.
     *
     * @return self
     */
    ...
    public function setStatus($status)
    {
        if (!is_null($status) && (mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling NotificationPayment., must be smaller than or equal to 20.');
        }
     ...
     * Sets payment_id
     *
     * @param float|null $payment_id Уникальный идентификатор транзакции в системе Т‑Бизнес.
     *
     * @return self
     */
    ...
    public function setErrorCode($error_code)
    {
        if (!is_null($error_code) && (mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling NotificationPayment., must be smaller than or equal to 20.');
        }
     ...
     * Sets rebill_id
     *
     * @param float|null $rebill_id Идентификатор автоплатежа.
     *
     * @return self
     */
     ...
     * Sets card_id
     *
     * @param float|null $card_id Идентификатор карты в системе Т‑Бизнес.
     *
     * @return self
     */
     ...
     * Sets pan
     *
     * @param string|null $pan Замаскированный номер карты или телефона.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token Подпись запроса. Формируется по такому же принципу, как и в случае запросов в Т‑Бизнес.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \RoxlTBankApi\Model\DataNotification|null
     */
     ...
     * Sets data
     *
     * @param \RoxlTBankApi\Model\DataNotification|null $data data
     *
     * @return self
     */
