...
/**
 * SendClosingReceiptReceipt Class Doc Comment
 *
 * @category Class
 ...
 */
class SendClosingReceiptReceipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendClosingReceipt_Receipt';
    ...
    protected static $openAPITypes = [
        'ffd_version' => 'string',
        'client_info' => '\RoxlTBankApi\Model\ClientInfo',
        'taxation' => 'string',
        'email' => 'string',
        'phone' => 'string',
        'customer' => 'string',
        'customer_inn' => 'string',
        'items' => '\RoxlTBankApi\Model\ItemsFFD105[]',
        'payments' => '\RoxlTBankApi\Model\Payments'
    ];
     ...
     * @return string[]
     */
    public function getTaxationAllowableValues()
    {
        return [
            self::TAXATION_OSN,
            self::TAXATION_USN_INCOME,
            self::TAXATION_USN_INCOME_OUTCOME,
            self::TAXATION_ESN,
            self::TAXATION_PATENT,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ffd_version'] === null) {
            $invalidProperties[] = "'ffd_version' can't be null";
        }
        if ($this->container['taxation'] === null) {
            $invalidProperties[] = "'taxation' can't be null";
        }
        $allowedValues = $this->getTaxationAllowableValues();
        if (!is_null($this->container['taxation']) && !in_array($this->container['taxation'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'taxation', must be one of '%s'",
                $this->container['taxation'],
     ...
     * Sets ffd_version
     *
     * @param string $ffd_version Версия ФФД. Возможные значения: * FfdVersion: `1.2`, * FfdVersion: `1.05`.  Версия ФФД по умолчанию — `1.05`.
     *
     * @return self
     */
     ...
     * Gets client_info
     *
     * @return \RoxlTBankApi\Model\ClientInfo|null
     */
     ...
     * Sets client_info
     *
     * @param \RoxlTBankApi\Model\ClientInfo|null $client_info client_info
     *
     * @return self
     */
     ...
     * Sets taxation
     *
     * @param string $taxation `Тег ФФД: 1055.`   Система налогообложения. Возможные значения: * `osn` — общая СН; * `usn_income` — упрощенная СН (доходы); * `usn_income_outcome` — упрощенная СН (доходы минус расходы); * `esn` — единый сельскохозяйственный налог; * `patent` — патентная СН.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getTaxationAllowableValues();
        if (!in_array($taxation, $allowedValues, true)) {
     ...
     * Sets email
     *
     * @param string|null $email `Тег ФФД: 1008.`<br>  Электронная почта клиента. Параметр должен быть заполнен, если не передано значение  в параметре `Phone`.
     *
     * @return self
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 64)) {
            throw new \InvalidArgumentException('invalid length for $email when calling SendClosingReceiptReceipt., must be smaller than or equal to 64.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone `Тег ФФД: 1008.`<br>  Телефон клиента в формате `+{Ц}`. Параметр должен быть заполнен, если не передано значение  в параметре `Email`.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 64)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling SendClosingReceiptReceipt., must be smaller than or equal to 64.');
        }
     ...
     * Sets customer
     *
     * @param string|null $customer `Тег ФФД: 1227`   Идентификатор/имя клиента.
     *
     * @return self
     */
    ...
    {
        return $this->container['customer_inn'];
    }

    /**
     * Sets customer_inn
     *
     * @param string|null $customer_inn `Тег ФФД: 1228`   ИНН клиента.
     *
     * @return self
     */
    public function setCustomerInn($customer_inn)
    {

        if (is_null($customer_inn)) {
            throw new \InvalidArgumentException('non-nullable customer_inn cannot be null');
        }

        $this->container['customer_inn'] = $customer_inn;
     ...
     * Gets items
     *
     * @return \RoxlTBankApi\Model\ItemsFFD105[]
     */
     ...
     * Sets items
     *
     * @param \RoxlTBankApi\Model\ItemsFFD105[] $items Массив позиций чека с информацией о товарах (не более 100 позиций).
     *
     * @return self
     */
     ...
     * Gets payments
     *
     * @return \RoxlTBankApi\Model\Payments|null
     */
     ...
     * Sets payments
     *
     * @param \RoxlTBankApi\Model\Payments|null $payments payments
     *
     * @return self
     */
