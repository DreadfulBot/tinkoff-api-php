...
/**
 * GetAddCardStateResponse Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class GetAddCardStateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAddCardStateResponse';
    ...
    public const STATUS_FORM_SHOWED = 'FORM_SHOWED';
    public const STATUS_THREE_DS_CHECKING = 'THREE_DS_CHECKING';
    public const STATUS_THREE_DS_CHECKED = 'THREE_DS_CHECKED';
    ...
    public function getStatusAllowableValues()
    {
        return [
            self::STATUS__NEW,
            self::STATUS_FORM_SHOWED,
            self::STATUS_THREE_DS_CHECKING,
            self::STATUS_THREE_DS_CHECKED,
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['card_id']) && (mb_strlen($this->container['card_id']) > 40)) {
            $invalidProperties[] = "invalid value for 'card_id', the character length must be smaller than or equal to 40.";
        }
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling GetAddCardStateResponse., must be smaller than or equal to 20.');
        }
     ...
     * Sets request_key
     *
     * @param string $request_key Идентификатор запроса на привязку карты.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Статус привязки карты: * `NEW` — новая сессия привязки карты, * `FORM_SHOWED` — показ формы привязки карты, * `THREE_DS_CHECKING` — отправка клиента на проверку 3DS; * `THREE_DS_CHECKED` — клиент успешно прошел проверку 3DS; * `AUTHORIZING` — отправка платежа на 0 руб; * `AUTHORIZED` — платеж на 0 руб прошел успешно; * `COMPLETED` — карта успешно привязана, * `REJECTED` — привязать карту не удалось.
     *
     * @return self
     */
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling GetAddCardStateResponse., must be smaller than or equal to 20.');
        }
    ...
    {
        if (!is_null($card_id) && (mb_strlen($card_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $card_id when calling GetAddCardStateResponse., must be smaller than or equal to 40.');
        }
     ...
     * Sets error_code
     *
     * @param string|null $error_code Код ошибки. `0` в случае успеха.
     *
     * @return self
     */
    public function setErrorCode($error_code)
    {
        if (!is_null($error_code) && (mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling GetAddCardStateResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling GetAddCardStateResponse., must be smaller than or equal to 255.');
        }
    ...
    public function setCustomerKey($customer_key)
    {
        if (!is_null($customer_key) && (mb_strlen($customer_key) > 36)) {
            throw new \InvalidArgumentException('invalid length for $customer_key when calling GetAddCardStateResponse., must be smaller than or equal to 36.');
        }
