...
/**
 * PaymentsCheckOrder Class Doc Comment
 *
 * @category Class
 * @description Детали
 * @package  OpenAPI\Client
 ...
 */
class PaymentsCheckOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentsCheckOrder';
    ...
    protected static array $openAPINullables = [
        ...
        'error_code' => false,
        'message' => false,
        'sbp_payment_id' => false,
        'sbp_customer_id' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'message' => 'Message',
        'sbp_payment_id' => 'SbpPaymentId',
        'sbp_customer_id' => 'SbpCustomerId'
    ];
    ...
    protected static $setters = [
        ...
        'message' => 'setMessage',
        'sbp_payment_id' => 'setSbpPaymentId',
        'sbp_customer_id' => 'setSbpCustomerId'
    ];
    ...
    protected static $getters = [
        ...
        'message' => 'getMessage',
        'sbp_payment_id' => 'getSbpPaymentId',
        'sbp_customer_id' => 'getSbpCustomerId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sbp_payment_id', $data ?? [], null);
        $this->setIfExists('sbp_customer_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount Сумма операции в копейках.
     *
     * @return self
     */
     ...
     * Sets rrn
     *
     * @param string|null $rrn RRN операции.
     *
     * @return self
     */
     ...
     * Sets success
     *
     * @param string $success Успешность прохождения запроса — `true`/`false`.
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param float|null $error_code Код ошибки.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getSbpPaymentId()
    {
        return $this->container['sbp_payment_id'];
    }

    /**
     * Sets sbp_payment_id
     *
     * @param string|null $sbp_payment_id Идентификатор платежа в СБП.
     *
     * @return self
     */
    public function setSbpPaymentId($sbp_payment_id)
    {
        if (is_null($sbp_payment_id)) {
            throw new \InvalidArgumentException('non-nullable sbp_payment_id cannot be null');
        }
        $this->container['sbp_payment_id'] = $sbp_payment_id;

        return $this;
    }

    /**
     * Gets sbp_customer_id
     *
     * @return string|null
     */
    public function getSbpCustomerId()
    {
        return $this->container['sbp_customer_id'];
    }

    /**
     * Sets sbp_customer_id
     *
     * @param string|null $sbp_customer_id Хэшированный номер телефона покупателя.
     *
     * @return self
     */
    public function setSbpCustomerId($sbp_customer_id)
    {
        if (is_null($sbp_customer_id)) {
            throw new \InvalidArgumentException('non-nullable sbp_customer_id cannot be null');
        }
        $this->container['sbp_customer_id'] = $sbp_customer_id;
