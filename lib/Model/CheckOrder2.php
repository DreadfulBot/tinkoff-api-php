...
class CheckOrder2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'details' => 'string',
        'payments' => '\RoxlTBankApi\Model\PaymentsCheckOrder[]'
    ];
    ...
    */
     ...
     * Gets payments
     *
     * @return \RoxlTBankApi\Model\PaymentsCheckOrder[]
     */
     ...
     * Sets payments
     *
     * @param \RoxlTBankApi\Model\PaymentsCheckOrder[] $payments payments
     *
     * @return self
     */
