 ...
 */
class Confirm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Confirm';
    ...
    protected static $openAPITypes = [
        ...
        'ip' => 'string',
        'amount' => 'float',
        'receipt' => '\RoxlTBankApi\Model\ConfirmReceipt',
        'shops' => '\RoxlTBankApi\Model\Shops[]',
        'route' => 'string',
        'source' => 'string'
    ];
    ...
    */
    ...
    public function setPaymentId($payment_id)
    {
        if ((mb_strlen($payment_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling Confirm., must be smaller than or equal to 20.');
        }
     ...
     * Sets amount
     *
     * @param float|null $amount Сумма в копейках. Если не передан, используется `Amount`, переданный в методе **Init**.
     *
     * @return self
     */
     ...
     * Gets receipt
     *
     * @return \RoxlTBankApi\Model\ConfirmReceipt|null
     */
     ...
     * Sets receipt
     *
     * @param \RoxlTBankApi\Model\ConfirmReceipt|null $receipt receipt
     *
     * @return self
     */
     ...
     * Gets shops
     *
     * @return \RoxlTBankApi\Model\Shops[]|null
     */
     ...
     * Sets shops
     *
     * @param \RoxlTBankApi\Model\Shops[]|null $shops Обязательный для маркетплейсов. JSON-объект с данными маркетплейса.
     *
     * @return self
     */
