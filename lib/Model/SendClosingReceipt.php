 ...
 */
class SendClosingReceipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendClosingReceipt';
    ...
    protected static $openAPITypes = [
        'terminal_key' => 'string',
        'payment_id' => 'string',
        'receipt' => '\RoxlTBankApi\Model\SendClosingReceiptReceipt',
        'token' => 'string'
    ];
    ...
    */
     ...
     * Gets receipt
     *
     * @return \RoxlTBankApi\Model\SendClosingReceiptReceipt
     */
     ...
     * Sets receipt
     *
     * @param \RoxlTBankApi\Model\SendClosingReceiptReceipt $receipt receipt
     *
     * @return self
     */
