 ...
 */
class NotificationFiscalization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationFiscalization';
    ...
    protected static $openAPITypes = [
        ...
        'receipt' => '\RoxlTBankApi\Model\NotificationFiscalizationReceipt',
        'type' => 'string',
        'token' => 'string',
        'ofd' => 'string',
        'url' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('status', $data ?? [], 'RECEIPT');
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        if (!is_null($terminal_key) && (mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling NotificationFiscalization., must be smaller than or equal to 20.');
        }
    ...
    public function setOrderId($order_id)
    {
        if (!is_null($order_id) && (mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling NotificationFiscalization., must be smaller than or equal to 36.');
        }
     ...
     * Sets status
     *
     * @param string|null $status Для уведомлений о фискализации — всегда `RECEIPT`.
     *
     * @return self
     */
    public function setStatus($status)
    {
        if (!is_null($status) && (mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling NotificationFiscalization., must be smaller than or equal to 20.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if (!is_null($error_code) && (mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling NotificationFiscalization., must be smaller than or equal to 20.');
        }
     ...
     * Gets receipt
     *
     * @return \RoxlTBankApi\Model\NotificationFiscalizationReceipt|null
     */
     ...
     * Sets receipt
     *
     * @param \RoxlTBankApi\Model\NotificationFiscalizationReceipt|null $receipt receipt
     *
     * @return self
     */
