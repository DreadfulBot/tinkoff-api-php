 ...
 */
class Confirm2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Confirm-2';
    ...
    public const STATUS_AUTH_FAIL = 'AUTH_FAIL';
    ...
    public const STATUS_DEADLINE_EXPIRED = 'DEADLINE_EXPIRED';
    public const STATUS_FORM_SHOWED = 'FORM_SHOWED';
    public const STATUS_PARTIAL_REFUNDED = 'PARTIAL_REFUNDED';
    public const STATUS_PREAUTHORIZING = 'PREAUTHORIZING';
    public const STATUS_PROCESSING = 'PROCESSING';
    public const STATUS__3_DS_CHECKING = '3DS_CHECKING';
    public const STATUS__3_DS_CHECKED = '3DS_CHECKED';
    ...
    public function getStatusAllowableValues()
    {
        return [
            ...
            self::STATUS_DEADLINE_EXPIRED,
            self::STATUS_FORM_SHOWED,
            self::STATUS_PARTIAL_REFUNDED,
            self::STATUS_PREAUTHORIZING,
            self::STATUS_PROCESSING,
            self::STATUS__3_DS_CHECKING,
            self::STATUS__3_DS_CHECKED,
            self::STATUS_REVERSING,
    ...
    */
     ...
     * Sets payment_id
     *
     * @param string $payment_id Идентификатор транзакции в системе Т‑Бизнес.
     *
     * @return self
     */
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling Confirm2., must be smaller than or equal to 255.');
        }
     ...
     * Sets params
     *
     * @param \RoxlTBankApi\Model\ItemsParams[]|null $params Детали для платежей в рассрочку.
     *
     * @return self
     */
