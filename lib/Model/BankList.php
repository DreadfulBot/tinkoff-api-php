 ...
 */
class BankList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankList';
    ...
    protected static $setters = [
        'bank_id' => 'setBankId',
        'nspk_bank_id' => 'setNspkBankId',
        'bank_name' => 'setBankName',
        'bank_logo' => 'setBankLogo',
        'bank_order' => 'setBankOrder'
    ];
    ...
    protected static $getters = [
        'bank_id' => 'getBankId',
        'nspk_bank_id' => 'getNspkBankId',
        'bank_name' => 'getBankName',
        'bank_logo' => 'getBankLogo',
        'bank_order' => 'getBankOrder'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('nspk_bank_id', $data ?? [], null);
        $this->setIfExists('bank_name', $data ?? [], null);
        $this->setIfExists('bank_logo', $data ?? [], null);
        $this->setIfExists('bank_order', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['bank_id']) > 200)) {
            $invalidProperties[] = "invalid value for 'bank_id', the character length must be smaller than or equal to 200.";
        }

        if ($this->container['nspk_bank_id'] === null) {
            $invalidProperties[] = "'nspk_bank_id' can't be null";
        }
        if ((mb_strlen($this->container['nspk_bank_id']) > 200)) {
            $invalidProperties[] = "invalid value for 'nspk_bank_id', the character length must be smaller than or equal to 200.";
        }

        if ($this->container['bank_name'] === null) {
            $invalidProperties[] = "'bank_name' can't be null";
        }
        if ((mb_strlen($this->container['bank_name']) > 200)) {
            $invalidProperties[] = "invalid value for 'bank_name', the character length must be smaller than or equal to 200.";
        }

        if ($this->container['bank_logo'] === null) {
            $invalidProperties[] = "'bank_logo' can't be null";
        }
        if ((mb_strlen($this->container['bank_logo']) > 200)) {
            $invalidProperties[] = "invalid value for 'bank_logo', the character length must be smaller than or equal to 200.";
        }

        if ($this->container['bank_order'] === null) {
            $invalidProperties[] = "'bank_order' can't be null";
        }
     ...
     * Sets bank_id
     *
     * @param string $bank_id Внутренний идентификатор банка.
     *
     * @return self
     */
    public function setBankId($bank_id)
    {
        if ((mb_strlen($bank_id) > 200)) {
            throw new \InvalidArgumentException('invalid length for $bank_id when calling BankList., must be smaller than or equal to 200.');
        }
     ...
     * @return string
     */
    public function getNspkBankId()
    {
        return $this->container['nspk_bank_id'];
    }

    /**
     * Sets nspk_bank_id
     *
     * @param string $nspk_bank_id Идентификатор банка в системе НСПК.
     *
     * @return self
     */
    public function setNspkBankId($nspk_bank_id)
    {
        if ((mb_strlen($nspk_bank_id) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nspk_bank_id when calling BankList., must be smaller than or equal to 200.');
        }


        if (is_null($nspk_bank_id)) {
            throw new \InvalidArgumentException('non-nullable nspk_bank_id cannot be null');
        }

        $this->container['nspk_bank_id'] = $nspk_bank_id;
     ...
     * Sets bank_name
     *
     * @param string $bank_name Наименование банка.
     *
     * @return self
     */
    public function setBankName($bank_name)
    {
        if ((mb_strlen($bank_name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling BankList., must be smaller than or equal to 200.');
        }
     ...
     * Sets bank_logo
     *
     * @param string $bank_logo Ссылка на логотип банка.
     *
     * @return self
     */
    public function setBankLogo($bank_logo)
    {
        if ((mb_strlen($bank_logo) > 200)) {
            throw new \InvalidArgumentException('invalid length for $bank_logo when calling BankList., must be smaller than or equal to 200.');
        }
    ...
    {
        return $this->container['bank_order'];
    }

    /**
     * Sets bank_order
     *
     * @param int $bank_order Порядок для сортировки.
     *
     * @return self
     */
    public function setBankOrder($bank_order)
    {

        if (is_null($bank_order)) {
            throw new \InvalidArgumentException('non-nullable bank_order cannot be null');
        }

        $this->container['bank_order'] = $bank_order;
