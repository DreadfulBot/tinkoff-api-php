...
/**
 * FinishAuthorize200Response Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class FinishAuthorize200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinishAuthorize_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'acs_trans_id' => 'string',
        'acs_interface' => 'string',
        'acs_ui_template' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'pa_req' => null,
        'acs_url' => 'uri',
        'tds_server_trans_id' => null,
        'acs_trans_id' => null,
        'acs_interface' => 'uri',
        'acs_ui_template' => 'uri',
        'acs_signed_content' => 'uri',
        'acs_reference_number' => 'uri',
        'sdk_trans_id' => 'uri'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'pa_req' => false,
		'acs_url' => false,
		'tds_server_trans_id' => false,
		'acs_trans_id' => false,
		'acs_interface' => false,
		'acs_ui_template' => false,
    ...
    protected static $attributeMap = [
        ...
        'pa_req' => 'PaReq',
        'acs_url' => 'ACSUrl',
        'tds_server_trans_id' => 'TdsServerTransId',
        'acs_trans_id' => 'AcsTransId',
        'acs_interface' => 'AcsInterface',
        'acs_ui_template' => 'AcsUiTemplate',
    ...
    protected static $setters = [
        ...
        'pa_req' => 'setPaReq',
        'acs_url' => 'setAcsUrl',
        'tds_server_trans_id' => 'setTdsServerTransId',
        'acs_trans_id' => 'setAcsTransId',
        'acs_interface' => 'setAcsInterface',
        'acs_ui_template' => 'setAcsUiTemplate',
    ...
    protected static $getters = [
        ...
        'pa_req' => 'getPaReq',
        'acs_url' => 'getAcsUrl',
        'tds_server_trans_id' => 'getTdsServerTransId',
        'acs_trans_id' => 'getAcsTransId',
        'acs_interface' => 'getAcsInterface',
        'acs_ui_template' => 'getAcsUiTemplate',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tds_server_trans_id', $data ?? [], null);
        $this->setIfExists('acs_trans_id', $data ?? [], null);
        $this->setIfExists('acs_interface', $data ?? [], null);
        $this->setIfExists('acs_ui_template', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payment_id']) && (mb_strlen($this->container['payment_id']) > 20)) {
            $invalidProperties[] = "invalid value for 'payment_id', the character length must be smaller than or equal to 20.";
        }
        ...
        if ($this->container['tds_server_trans_id'] === null) {
            $invalidProperties[] = "'tds_server_trans_id' can't be null";
        }
        if ($this->container['acs_trans_id'] === null) {
            $invalidProperties[] = "'acs_trans_id' can't be null";
        }
        if ($this->container['acs_reference_number'] === null) {
            $invalidProperties[] = "'acs_reference_number' can't be null";
        }
     ...
     * Sets terminal_key
     *
     * @param string $terminal_key Идентификатор терминала. Выдается мерчанту в Т‑Бизнес при заведении терминала.
     *
     * @return self
     */
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling FinishAuthorize200Response., must be smaller than or equal to 20.');
        }
     ...
     * Sets amount
     *
     * @param float $amount Сумма в копейках.
     *
     * @return self
     */
    ...
    public function setOrderId($order_id)
    {
        if ((mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling FinishAuthorize200Response., must be smaller than or equal to 36.');
        }
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling FinishAuthorize200Response., must be smaller than or equal to 20.');
        }
     ...
     * Sets payment_id
     *
     * @param string|null $payment_id Идентификатор платежа в системе Т‑Бизнес.
     *
     * @return self
     */
    public function setPaymentId($payment_id)
    {
        if (!is_null($payment_id) && (mb_strlen($payment_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling FinishAuthorize200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling FinishAuthorize200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling FinishAuthorize200Response., must be smaller than or equal to 255.');
        }
     ...
     * Sets rebill_id
     *
     * @param string|null $rebill_id Идентификатор рекуррентного платежа.
     *
     * @return self
     */
     ...
     * Sets card_id
     *
     * @param string|null $card_id Идентификатор карты в системе Т‑Бизнес. Передается только для cохраненной карты.
     *
     * @return self
     */
     ...
     * Sets md
     *
     * @param string|null $md Идентификатор транзакции в системе Т‑Бизнес.
     *
     * @return self
     */
     ...
     * Sets pa_req
     *
     * @param string|null $pa_req Шифрованная строка, содержащая результаты 3-D Secure аутентификации. Возвращается в ответе от ACS.
     *
     * @return self
     */
     ...
     * Sets acs_url
     *
     * @param string|null $acs_url Если в ответе метода **FinishAuthorize** возвращается статус `3DS_CHECKING`,  мерчанту нужно сформировать запрос на URL ACS банка,  который выпустил карту — параметр `ACSUrl` в ответе, и вместе с этим перенаправить клиента на эту же страницу ACSUrl для прохождения 3DS.
     *
     * @return self
     */
    ...
    /**
     * Gets tds_server_trans_id
     *
     * @return string
     */
    public function getTdsServerTransId()
    {
        return $this->container['tds_server_trans_id'];
    }

    /**
     * Sets tds_server_trans_id
     *
     * @param string $tds_server_trans_id Уникальный идентификатор транзакции, генерируемый 3DS-Server. Обязательный параметр для 3DS второй версии.
     *
     * @return self
     */
    public function setTdsServerTransId($tds_server_trans_id)
    {

        if (is_null($tds_server_trans_id)) {
            throw new \InvalidArgumentException('non-nullable tds_server_trans_id cannot be null');
        }

        $this->container['tds_server_trans_id'] = $tds_server_trans_id;
     ...
     * Sets acs_trans_id
     *
     * @param string $acs_trans_id Идентификатор транзакции, присвоенный ACS, который вернулся в ответе **FinishAuthorize**.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getAcsInterface()
    {
        return $this->container['acs_interface'];
    }

    /**
     * Sets acs_interface
     *
     * @param string|null $acs_interface `Обязательное поле, если `Transaction Status` = `C`.`<br><br> Тип пользовательского интерфейса ACS. Возможные значения:   - `01` — Native UI,   - `02` — HTML UI.
     *
     * @return self
     */
    public function setAcsInterface($acs_interface)
    {

        if (is_null($acs_interface)) {
            throw new \InvalidArgumentException('non-nullable acs_interface cannot be null');
        }

        $this->container['acs_interface'] = $acs_interface;

        return $this;
    }

    /**
     * Gets acs_ui_template
     *
     * @return string|null
     */
    public function getAcsUiTemplate()
    {
        return $this->container['acs_ui_template'];
    }

    /**
     * Sets acs_ui_template
     *
     * @param string|null $acs_ui_template `Обязательное поле, если `Transaction Status` = `C`.`<br><br>  Формат шаблона пользовательского интерфейса ACS. Возможные значения:     - `01` — Text;    - `02` — Single Select;    - `03` — Multi Select;    - `04` — OOB;    - `05` — HTML Other (valid only for HTML UI).
     *
     * @return self
     */
    public function setAcsUiTemplate($acs_ui_template)
    {

        if (is_null($acs_ui_template)) {
            throw new \InvalidArgumentException('non-nullable acs_ui_template cannot be null');
        }

        $this->container['acs_ui_template'] = $acs_ui_template;
     ...
     *
     * @param string|null $acs_signed_content `Обязательное поле, если `Transaction Status` = `C`.`<br><br>  JWS object, представленный как string, который создан ACS для ARes. Содержит:    - ACS URL — 3DS SDK должен отправить Challenge Request на этот URL,    - ACS Ephemeral Public Key (QT),    - SDK Ephemeral Public Key (QC).
     *
     * @return self
     */
     ...
     *
     * @param string $acs_reference_number Уникальный идентификатор, назначенный EMVCo.
     *
     * @return self
     */
     ...
     * Sets sdk_trans_id
     *
     * @param string $sdk_trans_id Уникальный идентификатор транзакции, назначенный 3DS SDK для идентификации одной транзакции, который вернулся в ответе **FinishAuthorize**.
     *
     * @return self
     */
