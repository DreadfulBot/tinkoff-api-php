...
/**
 * Submit3DSAuthorization200Response Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class Submit3DSAuthorization200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Submit3DSAuthorization_200_response';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Статус транзакции: - `CONFIRMED` — при успешном сценарии и одностадийном проведении платежа; - `AUTHORIZED` — при успешном сценарии и двухстадийном проведении платежа;  - `REJECTED` — при неуспешном сценарии.
     *
     * @return self
     */
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling Submit3DSAuthorization200Response., must be smaller than or equal to 20.');
        }
