...
/**
 * ReceiptFFD12 Class Doc Comment
 *
 * @category Class
 ...
 */
class ReceiptFFD12 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Receipt_FFD_12';
    ...
    */
     ...
     * Sets ffd_version
     *
     * @param string $ffd_version Версия ФФД. Возможные значения: * FfdVersion: 1.2, * FfdVersion: 1.05.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email `Тег ФФД: 1008`   Электронная почта клиента. Параметр должен быть заполнен, если не передано значение  в параметре `Phone`.
     *
     * @return self
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 64)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ReceiptFFD12., must be smaller than or equal to 64.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone `Тег ФФД: 1008`   Телефон клиента в формате `+{Ц}`. Параметр должен быть заполнен, если не передано значение  в параметре `Email`.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 64)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling ReceiptFFD12., must be smaller than or equal to 64.');
        }
     ...
     * Gets items
     *
     * @return \RoxlTBankApi\Model\ItemsFFD12[]
     */
