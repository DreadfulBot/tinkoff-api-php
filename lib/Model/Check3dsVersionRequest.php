...
/**
 * Check3dsVersionRequest Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class Check3dsVersionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Check3dsVersion_request';
    ...
    */
    ...
    public function setPaymentId($payment_id)
    {
        if ((mb_strlen($payment_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling Check3dsVersionRequest., must be smaller than or equal to 20.');
        }
    ...
    public function setTerminalKey($terminal_key)
    {
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling Check3dsVersionRequest., must be smaller than or equal to 20.');
        }
     ...
     * Sets card_data
     *
     * @param string $card_data Зашифрованные данные карты в формате:    ```   PAN=4300000000000777;ExpDate=0519;CardHolder=IVAN PETROV;CVV=111   ```
     *
     * @return self
     */
