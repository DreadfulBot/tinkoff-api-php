...
/**
 * GetQRStateResponseFULL Class Doc Comment
 *
 * @category Class
 * @package  RoxlTBankApi
 * @author   OpenAPI Generator team
 ...
 */
class GetQRStateResponseFULL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetQRStateResponse_FULL';
    ...
    protected static $openAPITypes = [
        ...
        'error_code' => 'string',
        'status' => 'string',
        'qr_cancel_code' => 'string',
        'qr_cancel_message' => 'string',
        'order_id' => 'string',
        'amount' => 'float',
        'message' => 'string'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'error_code' => false,
		'status' => false,
		'qr_cancel_code' => false,
		'qr_cancel_message' => false,
		'order_id' => false,
		'amount' => false,
		'message' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'status' => 'Status',
        'qr_cancel_code' => 'QrCancelCode',
        'qr_cancel_message' => 'QrCancelMessage',
        'order_id' => 'OrderId',
        'amount' => 'Amount',
        'message' => 'Message'
    ];
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'qr_cancel_code' => 'setQrCancelCode',
        'qr_cancel_message' => 'setQrCancelMessage',
        'order_id' => 'setOrderId',
        'amount' => 'setAmount',
        'message' => 'setMessage'
    ];
    ...
    protected static $getters = [
        ...
        'status' => 'getStatus',
        'qr_cancel_code' => 'getQrCancelCode',
        'qr_cancel_message' => 'getQrCancelMessage',
        'order_id' => 'getOrderId',
        'amount' => 'getAmount',
        'message' => 'getMessage'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('qr_cancel_code', $data ?? [], null);
        $this->setIfExists('qr_cancel_message', $data ?? [], null);
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Статус платежа. <br> Обязателен, если не произошло ошибки при получении статуса.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getQrCancelCode()
    {
        return $this->container['qr_cancel_code'];
    }

    /**
     * Sets qr_cancel_code
     *
     * @param string|null $qr_cancel_code Код ошибки возврата, полученный от СБП.
     *
     * @return self
     */
    public function setQrCancelCode($qr_cancel_code)
    {

        if (is_null($qr_cancel_code)) {
            throw new \InvalidArgumentException('non-nullable qr_cancel_code cannot be null');
        }

        $this->container['qr_cancel_code'] = $qr_cancel_code;

        return $this;
    }

    /**
     * Gets qr_cancel_message
     *
     * @return string|null
     */
    public function getQrCancelMessage()
    {
        return $this->container['qr_cancel_message'];
    }

    /**
     * Sets qr_cancel_message
     *
     * @param string|null $qr_cancel_message Дополнительное описание ошибки, произошедшей при возврате по QR.
     *
     * @return self
     */
    public function setQrCancelMessage($qr_cancel_message)
    {

        if (is_null($qr_cancel_message)) {
            throw new \InvalidArgumentException('non-nullable qr_cancel_message cannot be null');
        }

        $this->container['qr_cancel_message'] = $qr_cancel_message;
     ...
     * Sets order_id
     *
     * @param string|null $order_id Номер заказа в системе мерчанта.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Сумма отмены в копейках.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Краткое описание ошибки, произошедшей при запросе статуса.
     *
     * @return self
     */
