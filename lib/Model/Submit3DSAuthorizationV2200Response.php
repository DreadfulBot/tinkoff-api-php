...
/**
 * Submit3DSAuthorizationV2200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Submit3DSAuthorizationV2200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Submit3DSAuthorizationV2_200_response';
    ...
    */
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling Submit3DSAuthorizationV2200Response., must be smaller than or equal to 20.');
        }
