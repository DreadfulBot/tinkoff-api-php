...
class InitFULL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'data' => '\RoxlTBankApi\Model\InitFULLDATA',
        'receipt' => '\RoxlTBankApi\Model\InitFULLReceipt',
    ...
    */
     ...
     * Gets data
     *
     * @return \RoxlTBankApi\Model\InitFULLDATA|null
     */
     ...
     * Sets data
     *
     * @param \RoxlTBankApi\Model\InitFULLDATA|null $data data
     *
     * @return self
     */
     ...
     * Gets receipt
     *
     * @return \RoxlTBankApi\Model\InitFULLReceipt|null
     */
     ...
     * Sets receipt
     *
     * @param \RoxlTBankApi\Model\InitFULLReceipt|null $receipt receipt
     *
     * @return self
     */
     ...
     * Sets shops
     *
     * @param \RoxlTBankApi\Model\Shops[]|null $shops JSON-объект с данными маркетплейса. Обязателен для маркетплейсов.
     *
     * @return self
     */
