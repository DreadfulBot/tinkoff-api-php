...
/**
 * NotificationQr Class Doc Comment
 *
 * @category Class
 * @description **Уведомление о статусе привязки счета по QR**  После привязки счета по QR магазину отправляется статус привязки и токен. Уведомление будет приходить по статусам &#x60;ACTIVE&#x60; и &#x60;INACTIVE&#x60;.
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NotificationQr implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationQr';
    ...
    */
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling NotificationQr., must be smaller than or equal to 20.');
        }
