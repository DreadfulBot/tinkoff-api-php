...
/**
 * ChargePCI200Response Class Doc Comment
 *
 * @category Class
 * @package  TinkoffApi
 * @author   OpenAPI Generator team
 ...
 */
class ChargePCI200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChargePCI_200_response';
    ...
    */
    ...
    public function setTerminalKey($terminal_key)
    {
        ...
        if ((mb_strlen($terminal_key) > 20)) {
            throw new \InvalidArgumentException('invalid length for $terminal_key when calling ChargePCI200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if ((mb_strlen($order_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling ChargePCI200Response., must be smaller than or equal to 36.');
        }
     ...
     * Sets status
     *
     * @param string $status Статус платежа. Возвращается один из статусов: * `CONFIRMED` — если платеж выполнен; * `REJECTED` — если платеж не выполнен.
     *
     * @return self
     */
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling ChargePCI200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setPaymentId($payment_id)
    {
        ...
        if ((mb_strlen($payment_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling ChargePCI200Response., must be smaller than or equal to 20.');
        }
    ...
    public function setErrorCode($error_code)
    {
        ...
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling ChargePCI200Response., must be smaller than or equal to 20.');
        }
