 ...
 */
class AgentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgentData';
    ...
    protected static $openAPIFormats = [
        ...
        'operation_name' => null,
        'phones' => null,
        'receiver_phones' => null,
        'transfer_phones' => null,
        'operator_name' => null,
    ...
    protected static array $openAPINullables = [
		...
		'phones' => false,
		'receiver_phones' => false,
		'transfer_phones' => false,
		'operator_name' => false,
    ...
    protected static $setters = [
        'agent_sign' => 'setAgentSign',
        'operation_name' => 'setOperationName',
        'phones' => 'setPhones',
        'receiver_phones' => 'setReceiverPhones',
        'transfer_phones' => 'setTransferPhones',
        'operator_name' => 'setOperatorName',
        'operator_address' => 'setOperatorAddress',
        'operator_inn' => 'setOperatorInn'
    ];
    ...
    protected static $getters = [
        'agent_sign' => 'getAgentSign',
        'operation_name' => 'getOperationName',
        'phones' => 'getPhones',
        'receiver_phones' => 'getReceiverPhones',
        'transfer_phones' => 'getTransferPhones',
        'operator_name' => 'getOperatorName',
        'operator_address' => 'getOperatorAddress',
        'operator_inn' => 'getOperatorInn'
    ];
    ...
    {
        $this->setIfExists('agent_sign', $data ?? [], null);
        $this->setIfExists('operation_name', $data ?? [], null);
        $this->setIfExists('phones', $data ?? [], null);
        $this->setIfExists('receiver_phones', $data ?? [], null);
        $this->setIfExists('transfer_phones', $data ?? [], null);
        $this->setIfExists('operator_name', $data ?? [], null);
        $this->setIfExists('operator_address', $data ?? [], null);
        $this->setIfExists('operator_inn', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['operation_name']) && (mb_strlen($this->container['operation_name']) > 64)) {
            $invalidProperties[] = "invalid value for 'operation_name', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['operator_name']) && (mb_strlen($this->container['operator_name']) > 64)) {
            $invalidProperties[] = "invalid value for 'operator_name', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['operator_address']) && (mb_strlen($this->container['operator_address']) > 243)) {
            $invalidProperties[] = "invalid value for 'operator_address', the character length must be smaller than or equal to 243.";
        }

        if (!is_null($this->container['operator_inn']) && (mb_strlen($this->container['operator_inn']) > 12)) {
            $invalidProperties[] = "invalid value for 'operator_inn', the character length must be smaller than or equal to 12.";
        }
     ...
     * @return string|null
     */
    public function getAgentSign()
    {
        return $this->container['agent_sign'];
    }

    /**
     * Sets agent_sign
     *
     * @param string|null $agent_sign `Тег ФФД: 1222`   Признак агента. Возможные значения: * `bank_paying_agent` — банковский платежный агент, * `bank_paying_subagent` — банковский платежный субагент, * `paying_agent` — платежный агент, * `paying_subagent` — платежный субагент, * `attorney` — поверенный, * `commission_agent` — комиссионер, * `another` — другой тип агента.
     *
     * @return self
     */
    public function setAgentSign($agent_sign)
    {

        if (is_null($agent_sign)) {
            throw new \InvalidArgumentException('non-nullable agent_sign cannot be null');
        }

        $this->container['agent_sign'] = $agent_sign;
     ...
     * Sets operation_name
     *
     * @param string|null $operation_name `Тег ФФД: 1044`   Наименование операции. Параметр обязательный, если `AgentSign` передан в значениях: * `bank_paying_agent`, * `bank_paying_subagent`.
     *
     * @return self
     */
    public function setOperationName($operation_name)
    {
        if (!is_null($operation_name) && (mb_strlen($operation_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $operation_name when calling AgentData., must be smaller than or equal to 64.');
        }


        if (is_null($operation_name)) {
            throw new \InvalidArgumentException('non-nullable operation_name cannot be null');
        }
     ...
     * Sets phones
     *
     * @param string[]|null $phones `Тег ФФД: 1073`   Телефоны платежного агента в формате `+{Ц}`. Параметр обязательный, если в `AgentSign` передан в значениях: * `bank_paying_agent`, * `bank_paying_subagent`, * `paying_agent`, * `paying_subagent`.
     *
     * @return self
     */
    ...
    /**
     * Gets receiver_phones
     *
     * @return string[]|null
     */
    public function getReceiverPhones()
    {
        return $this->container['receiver_phones'];
    }

    /**
     * Sets receiver_phones
     *
     * @param string[]|null $receiver_phones `Тег ФФД: 1074`   Телефоны оператора по приему платежей в формате `+{Ц}`. Параметр обязательный, если в `AgentSign` передан в значениях: * `paying_agent`, * `paying_subagent`.
     *
     * @return self
     */
    public function setReceiverPhones($receiver_phones)
    {

        if (is_null($receiver_phones)) {
            throw new \InvalidArgumentException('non-nullable receiver_phones cannot be null');
        }

        $this->container['receiver_phones'] = $receiver_phones;

        return $this;
    }

    /**
     * Gets transfer_phones
     *
     * @return string[]|null
     */
    public function getTransferPhones()
    {
        return $this->container['transfer_phones'];
    }

    /**
     * Sets transfer_phones
     *
     * @param string[]|null $transfer_phones `Тег ФФД: 1075`   Телефоны оператора перевода в формате `+{Ц}`. Параметр обязательный, если в `AgentSign` передан в значениях: * `bank_paying_agent`, * `bank_paying_subagent`.
     *
     * @return self
     */
    public function setTransferPhones($transfer_phones)
    {

        if (is_null($transfer_phones)) {
            throw new \InvalidArgumentException('non-nullable transfer_phones cannot be null');
        }

        $this->container['transfer_phones'] = $transfer_phones;
     ...
     * Sets operator_name
     *
     * @param string|null $operator_name `Тег ФФД: 1026`   Наименование оператора перевода. Параметр обязательный, если в `AgentSign` передан в значениях: * `bank_paying_agent`, * `bank_paying_subagent`.
     *
     * @return self
     */
    public function setOperatorName($operator_name)
    {
        if (!is_null($operator_name) && (mb_strlen($operator_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $operator_name when calling AgentData., must be smaller than or equal to 64.');
        }
    ...
    /**
     * Gets operator_address
     *
     * @return string|null
     */
    public function getOperatorAddress()
    {
        return $this->container['operator_address'];
    }

    /**
     * Sets operator_address
     *
     * @param string|null $operator_address `Тег ФФД: 1005`   Адрес оператора перевода. Параметр обязательный, если в `AgentSign` передан в значениях: * `bank_paying_agent`, * `bank_paying_subagent`.
     *
     * @return self
     */
    public function setOperatorAddress($operator_address)
    {
        if (!is_null($operator_address) && (mb_strlen($operator_address) > 243)) {
            throw new \InvalidArgumentException('invalid length for $operator_address when calling AgentData., must be smaller than or equal to 243.');
        }


        if (is_null($operator_address)) {
            throw new \InvalidArgumentException('non-nullable operator_address cannot be null');
        }

        $this->container['operator_address'] = $operator_address;
     ...
     * @return string|null
     */
    public function getOperatorInn()
    {
        return $this->container['operator_inn'];
    }

    /**
     * Sets operator_inn
     *
     * @param string|null $operator_inn `Тег ФФД: 1016`   ИНН оператора перевода. Параметр обязательный, если в `AgentSign` передан в значениях: * `bank_paying_agent`, * `bank_paying_subagent`.
     *
     * @return self
     */
    public function setOperatorInn($operator_inn)
    {
        if (!is_null($operator_inn) && (mb_strlen($operator_inn) > 12)) {
            throw new \InvalidArgumentException('invalid length for $operator_inn when calling AgentData., must be smaller than or equal to 12.');
        }


        if (is_null($operator_inn)) {
            throw new \InvalidArgumentException('non-nullable operator_inn cannot be null');
        }

        $this->container['operator_inn'] = $operator_inn;
