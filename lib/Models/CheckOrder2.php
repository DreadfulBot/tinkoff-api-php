 ...
 */
class CheckOrder2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckOrder-2';
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'details' => 'string',
        'payments' => '\ArtSchekoff\TBankApi\Models\PaymentsCheckOrder[]'
    ];
    ...
    */
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling CheckOrder2., must be smaller than or equal to 255.');
        }
     ...
     * Gets payments
     *
     * @return \ArtSchekoff\TBankApi\Models\PaymentsCheckOrder[]
     */
     ...
     * Sets payments
     *
     * @param \ArtSchekoff\TBankApi\Models\PaymentsCheckOrder[] $payments payments
     *
     * @return self
     */
