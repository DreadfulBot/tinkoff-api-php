 ...
 */
class Link200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Link_200_response';
    ...
    protected static $openAPITypes = [
        'params' => '\ArtSchekoff\TBankApi\Models\Link200ResponseParams',
        'success' => 'bool',
        'error_code' => 'string',
        'message' => 'string',
        'details' => 'string'
    ...
    */
     ...
     * Gets params
     *
     * @return \ArtSchekoff\TBankApi\Models\Link200ResponseParams
     */
     ...
     * Sets params
     *
     * @param \ArtSchekoff\TBankApi\Models\Link200ResponseParams $params params
     *
     * @return self
     */
    ...
    public function setErrorCode($error_code)
    {
        if ((mb_strlen($error_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $error_code when calling Link200Response., must be smaller than or equal to 20.');
        }
